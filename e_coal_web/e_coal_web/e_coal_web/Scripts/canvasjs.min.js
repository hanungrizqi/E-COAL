...
/*jshint ignore:start*/
(function () {
    function pa(h, m) { h.prototype = db(m.prototype); h.prototype.constructor = h; h.base = m.prototype } function db(h) { function m() { } m.prototype = h; return new m } function Wa(h, m, E) {
        "millisecond" === E ? h.setMilliseconds(h.getMilliseconds() + 1 * m) : "second" === E ? h.setSeconds(h.getSeconds() + 1 * m) : "minute" === E ? h.setMinutes(h.getMinutes() + 1 * m) : "hour" === E ? h.setHours(h.getHours() + 1 * m) : "day" === E ? h.setDate(h.getDate() + 1 * m) : "week" === E ? h.setDate(h.getDate() + 7 * m) : "month" === E ? h.setMonth(h.getMonth() + 1 * m) : "year" === E && h.setFullYear(h.getFullYear() +
            1 * m); return h
    } function ba(h, m) { var E = !1; 0 > h && (E = !0, h *= -1); h = "" + h; for (m = m ? m : 1; h.length < m;)h = "0" + h; return E ? "-" + h : h } function Ga(h) { if (!h) return h; h = h.replace(/^\s\s*/, ""); for (var m = /\s/, E = h.length; m.test(h.charAt(--E));); return h.slice(0, E + 1) } function Ca(h) {
        h.roundRect = function (h, E, r, w, ra, A, B, v) {
            B && (this.fillStyle = B); v && (this.strokeStyle = v); "undefined" === typeof ra && (ra = 5); this.lineWidth = A; this.beginPath(); this.moveTo(h + ra, E); this.lineTo(h + r - ra, E); this.quadraticCurveTo(h + r, E, h + r, E + ra); this.lineTo(h +
                r, E + w - ra); this.quadraticCurveTo(h + r, E + w, h + r - ra, E + w); this.lineTo(h + ra, E + w); this.quadraticCurveTo(h, E + w, h, E + w - ra); this.lineTo(h, E + ra); this.quadraticCurveTo(h, E, h + ra, E); this.closePath(); B && this.fill(); v && 0 < A && this.stroke()
        }
    } function Qa(h, m) { return h - m } function V(h) { var m = ((h & 16711680) >> 16).toString(16), E = ((h & 65280) >> 8).toString(16); h = ((h & 255) >> 0).toString(16); m = 2 > m.length ? "0" + m : m; E = 2 > E.length ? "0" + E : E; h = 2 > h.length ? "0" + h : h; return "#" + m + E + h } function eb(h, m) {
        var E = this.length >>> 0, r = Number(m) || 0, r = 0 > r ? Math.ceil(r) :
            Math.floor(r); for (0 > r && (r += E); r < E; r++)if (r in this && this[r] === h) return r; return -1
    } function r(h) { return null === h || "undefined" === typeof h } function Da(h) { h.indexOf || (h.indexOf = eb); return h } function fb(h) { if (ja.fSDec) h[ia("`eeDwdouMhrudods")](ia("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { ja._fTWm && ja._fTWm(h) }) } function Xa(h, m, E) {
        E = E || "normal"; var r = h + "_" + m + "_" + E, w = Ya[r]; if (isNaN(w)) {
            try {
                if (!sa) {
                    var ra = document.body; sa = document.createElement("span"); sa.innerHTML = ""; var A = document.createTextNode("Mpgyi");
                    sa.appendChild(A); ra.appendChild(sa)
                } sa.style.display = ""; W(sa, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: m + "px", fontWeight: E }); w = Math.round(sa.offsetHeight); sa.style.display = "none"
            } catch (B) { w = Math.ceil(1.1 * m) } w = Math.max(w, m); Ya[r] = w
        } return w
    } function J(h, m) {
        var E = []; if (E = {
        ...
        }[h || "solid"]) for (var r = 0; r < E.length; r++)E[r] *= m; else E = []; return E
    } function P(h, m, E, w, ha) {
        w = w || []; ha = r(ha) ? gb ? { passive: !1, capture: !1 } : !1 : ha; w.push([h, m, E, ha]); return h.addEventListener ? (h.addEventListener(m, E, ha), E) : h.attachEvent ? (w = function (m) { m = m || window.event; m.preventDefault = m.preventDefault || function () { m.returnValue = !1 }; m.stopPropagation = m.stopPropagation || function () { m.cancelBubble = !0 }; E.call(h, m) }, h.attachEvent("on" + m,
            w), w) : !1
    } function hb(h) {
        if (h._menuButton) h.exportEnabled ? (W(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : va(h._menuButton); else if (h.exportEnabled && w) {
            var m = !1; h._menuButton = document.createElement("button"); wa(h, h._menuButton, "menu"); h._toolBar.appendChild(h._menuButton); P(h._menuButton, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers); P(h._menuButton, "click", function () {
            ...
            }, h.allDOMEventHandlers, !0); P(h._menuButton, "mousemove", function () { m || (W(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && W(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0); P(h._menuButton,
                "mouseout", function () { m || (W(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && W(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, h.allDOMEventHandlers, !0)
        } if (h.exportEnabled && h._dropdownMenu) {
            W(h._dropdownMenu, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }); for (var E = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText],
            ...
            outline: 0, fontSize: "14px", fontFamily: "Arial, Helvetica, sans-serif", padding: "5px 0px 5px 0px", textAlign: "left", lineHeight: "10px", backgroundColor: h.toolbar.itemBackgroundColor, boxShadow: "2px 2px 10px" + E
        }), h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), P(h._dropdownMenu, "blur", function () { va(h._dropdownMenu); h._dropDownCloseTime = new Date }, h.allDOMEventHandlers, !0), E = document.createElement("div"), W(E, { padding: "12px 8px 12px 8px" }), E.innerHTML = h._cultureInfo.printText, E.style.backgroundColor =
            h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), P(E, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers), P(E, "mousemove", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), P(E, "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), P(E, "click", function () {
                ...
                "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), P(E, "click", function () { h.exportChart({ format: "jpeg", fileName: h.exportFileName }); va(h._dropdownMenu) }, h.allDOMEventHandlers, !0), E = document.createElement("div"), W(E, { padding: "12px 8px 12px 8px" }), E.innerHTML = h._cultureInfo.savePNGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), P(E,
                    "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers), P(E, "mousemove", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), P(E, "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), P(E, "click", function () { h.exportChart({ format: "png", fileName: h.exportFileName }); va(h._dropdownMenu) }, h.allDOMEventHandlers, !0))
    } function Za(h,
        m, E) { h *= ma; m *= ma; h = E.getImageData(h, m, 2, 2).data; m = !0; for (E = 0; 4 > E; E++)if (h[E] !== h[E + 4] | h[E] !== h[E + 8] | h[E] !== h[E + 12]) { m = !1; break } return m ? h[0] << 16 | h[1] << 8 | h[2] : 0 } function na(h, m, E) { return h in m ? m[h] : E[h] } function Ma(h, m, E) {
            if (w && $a) {
                var r = h.getContext("2d"); Na = r.webkitBackingStorePixelRatio || r.mozBackingStorePixelRatio || r.msBackingStorePixelRatio || r.oBackingStorePixelRatio || r.backingStorePixelRatio || 1; ma = Ra / Na; h.width = m * ma; h.height = E * ma; Ra !== Na && (h.style.width = m + "px", h.style.height = E + "px", r.scale(ma,
                    ma))
            } else h.width = m, h.height = E
        } function ib(h) {
            if (!jb) {
                var m = !1, r = !1; "undefined" === typeof qa.Chart.creditHref ? (h.creditHref = ia("iuuqr;..b`ow`rkr/bnl."), h.creditText = ia("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), r = h.updateOption("creditHref")); if (h.creditHref && h.creditText) {
                    h._creditLink || (h._creditLink = document.createElement("a"), h._creditLink.setAttribute("class", "canvasjs-chart-credit"), h._creditLink.setAttribute("title", "JavaScript Charts"), W(h._creditLink, {
                        ...
                        right: "2px", top: h.height - 14 + "px", color: "dimgrey", textDecoration: "none", fontSize: "11px", fontFamily: "Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"
        ...
        } function La() { for (var h = null, m = 0; m < arguments.length; m++)h = arguments[m], h.style && (h.style.display = "inline") } function va() { for (var h = null, m = 0; m < arguments.length; m++)(h = arguments[m]) && h.style && (h.style.display = "none") } function Sa(h, m, r, w, ha) {
            if (null === h || "undefined" === typeof h) return "undefined" === typeof r ? m : r; h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof w && (h = Math.min(w, h), "undefined" !== typeof ha && (h = Math.max(ha,
                h))); return !isNaN(h) && h <= m && 0 <= h ? h : "undefined" === typeof r ? m : r
            ...
            this._defaultsKey = h; this._themeOptionsKey = m; this._index = w; this.parent = ha; this._eventListeners = []; h = {}; this.theme && r(this.parent) && r(m) && r(w) ? h = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === w ? h = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (w = Math.min(this.parent.themeOptions[m].length -
                1, w), h = this.parent.themeOptions[m][w])); this.themeOptions = h; this.options = E ? E : { _isPlaceholder: !0 }; this.setOptions(this.options, h)
        } function Ea(h, m, r, w, ha) { "undefined" === typeof ha && (ha = 0); this._padding = ha; this._x1 = h; this._y1 = m; this._x2 = r; this._y2 = w; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding } function ka(h, m) { ka.base.constructor.call(this, "TextBlock", null, m, null, null); this.ctx = h; this._isDirty = !0; this._wrappedText = null; this._initialize() } function Ta(h, m) {
            Ta.base.constructor.call(this,
                "Toolbar", "toolbar", m, null, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "toolbar"
        } function ya(h, m) {
            ya.base.constructor.call(this, "Title", "title", m, null, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "title"; if (r(this.options.margin) && h.options.subtitles) for (var E = h.options.subtitles, w = 0; w < E.length; w++)if ((r(E[w].horizontalAlign) && "center" === this.horizontalAlign || E[w].horizontalAlign === this.horizontalAlign) && (r(E[w].verticalAlign) && "top" ===
                this.verticalAlign || E[w].verticalAlign === this.verticalAlign) && !E[w].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break } "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.height = this.width = null; this.bounds = { x1: null, y1: null, x2: null, y2: null }
        } function Ia(h, m, r) {
            Ia.base.constructor.call(this, "Subtitle", "subtitles", m, r, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "subtitles"; this.isOptionsInArray = !0;
        ...
        } function Ua() { this.pool = [] } function Ja(h) { var m; h && Ka[h] && (m = Ka[h]); Ja.base.constructor.call(this, "CultureInfo", null, m, null, null) } var Ha = !1, ja = {}, w = !!document.createElement("canvas").getContext, qa = {
            Chart: {
        ...
        }, Ka = { en: {} }, B = w ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Fa = w ? "Impact, Charcoal, sans-serif" : "Arial", za = {
        ...
        }, K, aa, Q, U, Z; aa = "#333333"; Q = "#000000"; K = "#666666"; Z = U = "#000000"; var fa = 20, v = 14, Va = {
            colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Fa, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Fa, fontSize: v, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{
                indexLabelFontFamily: B, indexLabelFontSize: v,
                indexLabelFontColor: aa, indexLabelFontWeight: "normal", indexLabelLineThickness: 1
            }], axisX: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: aa, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 0, gridColor: K, stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
                    labelFontFamily: B,
                    labelFontSize: v, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: Z, color: U, thickness: 1, lineDashType: "dash"
                }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
            }], axisX2: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: aa, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 0, gridColor: K, stripLines: [{
                    labelFontFamily: B,
                    labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
                ...
                titleFontFamily: B, titleFontSize: fa, titleFontColor: aa, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v,
                labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 1, gridColor: K, stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: B, labelFontSize: v, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: Z, color: U, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
                    type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1,
                    lineDashType: "solid"
                }
            }], axisY2: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: aa, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 1, gridColor: K, stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
            ...
            }], legend: { fontFamily: B, fontSize: 14, fontColor: aa, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: B, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }, toolbar: {
        ...
        }; Q = aa = "#F5F5F5"; K = "#FFFFFF"; U = "#40BAF1"; Z = "#F5F5F5"; var fa = 20, v = 14, ab = {
            colorSet: "colorSet2", title: { fontFamily: B, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: B, fontSize: v, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: B, indexLabelFontSize: v, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
                titleFontFamily: B, titleFontSize: fa,
                titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickThickness: 1, tickColor: "#BBBBBB", gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: {
                    labelFontFamily: B, labelFontSize: v, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black",
                    color: "black", thickness: 1, lineDashType: "dot"
                }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
            }], axisX2: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{
                    labelFontFamily: B, labelFontSize: v, labelFontColor: "#FFA500",
                    labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1
                }], crosshair: { labelFontFamily: B, labelFontSize: v, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
            }], axisY: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: "#666666",
                labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: { labelFontFamily: B, labelFontSize: v, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: {
                    type: "zigzag", spacing: "2%", lineColor: "#BBBBBB",
                    lineThickness: 1, lineDashType: "solid"
                }
            }], axisY2: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: {
                    labelFontFamily: B,
                    labelFontSize: v, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot"
                }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
            }], legend: { fontFamily: B, fontSize: 14, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: B, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1 }, toolbar: {
        ...
        }; Q = aa = "#F5F5F5"; K = "#FFFFFF"; U = "#40BAF1"; Z = "#F5F5F5"; fa = 20; v = 14; Fa = {
            colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Fa, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Fa, fontSize: v, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: {
            ...
            }, data: [{ indexLabelFontFamily: B, indexLabelFontSize: v, indexLabelFontColor: Q, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 0, gridColor: K, stripLines: [{
                    labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300",
                ...
                titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal",
            ...
            axisY: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 1, gridColor: K, stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
                    labelFontFamily: B, labelFontSize: v, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z,
                    color: U, thickness: 1, lineDashType: "dash"
                }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
            }], axisY2: [{
                titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 1, gridColor: K, stripLines: [{
                    labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null,
                    color: "#FF7300", thickness: 1
                }], crosshair: { labelFontFamily: B, labelFontSize: v, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z, color: U, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
            }], legend: { fontFamily: B, fontSize: 14, fontColor: aa, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: {
                fontFamily: B, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1,
                fontColor: Q, backgroundColor: "rgba(0, 0, 0, .7)"
            }
        }; K = "#FFFFFF"; Q = aa = "#FAFAFA"; U = "#40BAF1"; Z = "#F5F5F5"; var fa = 20, v = 14, bb = {
            light1: Va, light2: ab, dark1: Fa, dark2: {
                colorSet: "colorSet2", backgroundColor: "#32373A", title: { fontFamily: B, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: B, fontSize: v, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: {
                    itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372",
                    buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5"
                }, data: [{ indexLabelFontFamily: B, indexLabelFontSize: v, indexLabelFontColor: Q, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
                    titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 1, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 0, gridColor: K, stripLines: [{
                ...
                axisY: [{
                    titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 0, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 1, gridColor: K, stripLines: [{ labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
                        labelFontFamily: B, labelFontSize: v, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z,
                        color: U, thickness: 1, lineDashType: "dash"
                    }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
                }], axisY2: [{
                    titleFontFamily: B, titleFontSize: fa, titleFontColor: Q, titleFontWeight: "normal", labelFontFamily: B, labelFontSize: v, labelFontColor: Q, labelFontWeight: "normal", lineThickness: 0, lineColor: K, tickThickness: 1, tickColor: K, gridThickness: 1, gridColor: K, stripLines: [{
                        labelFontFamily: B, labelFontSize: v, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null,
                        color: "#FF7300", thickness: 1
                    }], crosshair: { labelFontFamily: B, labelFontSize: v, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Z, color: U, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
                }], legend: { fontFamily: B, fontSize: 14, fontColor: aa, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: {
            ...
            ja.fSDec = function (h) { for (var m = "", r = 0; r < h.length; r++)m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return m }; delete qa[ja.fSDec("Bi`su")][ja.fSDec("bsdehuIsdg")];
            ja.pro = { sCH: qa[ja.fSDec("Bi`su")][ja.fSDec("bsdehuIsdg")] }; ja._fTWm = function (h) { if ("undefined" === typeof ja.pro.sCH && !cb) try { var m, r = h[ja.fSDec("buy")]; r[ja.fSDec("udyuC`rdmhod")] = ja.fSDec("unq"); r[ja.fSDec("gnou")] = 11 + ja.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg"); r[ja.fSDec("ghmmRuxmd")] = ja.fSDec("fsdx"); m = h.height - 11; r[ja.fSDec("ghmmUdyu")](ja.fSDec("B`ow`rKR!Ush`m"), 0, m) } catch (w) { } }
        })(); var gb = function () {
            var h = !1; try {
                var m = Object.defineProperty && Object.defineProperty({},
                    "passive", { get: function () { h = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m))
            } catch (r) { h = !1 } return h
        }(), Ya = {}, sa = null, lb = function () { this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) }, xa = function (h) { h.width = 1; h.height = 1; h.getContext("2d") && h.getContext("2d").clearRect(0, 0, 1, 1) }, mb = function (h, m, r) {
            ...
            A = /[^-+\dA-Z]/g; return function (v, J, O) {
                var K = O ? O.days : m, V = O ? O.months : w, P = O ? O.shortDays : r, T = O ? O.shortMonths : ha; O = ""; var W = !1; v = v && v.getTime ? v : v ? new Date(v) : new Date; if (isNaN(v)) throw SyntaxError("invalid date"); "UTC:" === J.slice(0, 4) && (J = J.slice(4), W = !0); O = W ? "getUTC" : "get"; var G = v[O + "Date"](), M = v[O + "Day"](), X = v[O + "Month"](), a = v[O + "FullYear"](), d = v[O + "Hours"](), c = v[O + "Minutes"](), b = v[O + "Seconds"](), e = v[O + "Milliseconds"](), f = W ? 0 : v.getTimezoneOffset(); return O = J.replace(h, function (l) {
                    switch (l) {
                        case "D": return G;
                        case "DD": return ba(G, 2); case "DDD": return P[M]; case "DDDD": return K[M]; case "M": return X + 1; case "MM": return ba(X + 1, 2); case "MMM": return T[X]; case "MMMM": return V[X]; case "Y": return parseInt(String(a).slice(-2)); case "YY": return ba(String(a).slice(-2), 2); case "YYY": return ba(String(a).slice(-3), 3); case "YYYY": return ba(a, 4); case "h": return d % 12 || 12; case "hh": return ba(d % 12 || 12, 2); case "H": return d; case "HH": return ba(d, 2); case "m": return c; case "mm": return ba(c, 2); case "s": return b; case "ss": return ba(b,
                            2); case "f": return ba(String(e), 3).slice(0, 1); case "ff": return ba(String(e), 3).slice(0, 2); case "fff": return ba(String(e), 3).slice(0, 3); case "t": return 12 > d ? "a" : "p"; case "tt": return 12 > d ? "am" : "pm"; case "T": return 12 > d ? "A" : "P"; case "TT": return 12 > d ? "AM" : "PM"; case "K": return W ? "UTC" : (String(v).match(B) || [""]).pop().replace(A, ""); case "z": return (0 < f ? "-" : "+") + Math.floor(Math.abs(f) / 60); case "zz": return (0 < f ? "-" : "+") + ba(Math.floor(Math.abs(f) / 60), 2); case "zzz": return (0 < f ? "-" : "+") + ba(Math.floor(Math.abs(f) /
                                60), 2) + ba(Math.abs(f) % 60, 2); default: return l.slice(1, l.length - 1)
                    }
                })
            }
        }(), ca = function (h, m, r) {
            if (null === h) return ""; if (!isFinite(h)) return h; h = Number(h); var w = 0 > h ? !0 : !1; w && (h *= -1); var B = r ? r.decimalSeparator : ".", v = r ? r.digitGroupSeparator : ",", A = ""; m = String(m); var A = 1, J = r = "", K = -1, O = [], V = [], P = 0, T = 0, W = 0, G = !1, Q = 0, J = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); m = null; for (var M = 0; J && M < J.length; M++)if (m = J[M], "." === m && 0 > K) K = M; else {
                if ("%" === m) A *= 100; else if ("\u2030" === m) { A *= 1E3; continue } else if ("," ===
                    m[0] && "." === m[m.length - 1]) { A /= Math.pow(1E3, m.length - 1); K = M + m.length - 1; continue } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (G = !0); 0 > K ? (O.push(m), "#" === m || "0" === m ? P++ : "," === m && W++) : (V.push(m), "#" !== m && "0" !== m || T++)
            } G && (m = Math.floor(h), J = -Math.floor(Math.log(h) / Math.LN10 + 1), Q = 0 === h ? 0 : 0 === m ? -(P + J) : String(m).length - P, A /= Math.pow(10, Q)); 0 > K && (K = M); A = (h * A).toFixed(T); m = A.split("."); A = (m[0] + "").split(""); h = (m[1] + "").split(""); A && "0" === A[0] && A.shift(); for (G = J = M = T = K = 0; 0 < O.length;)if (m = O.pop(), "#" === m ||
                "0" === m) if (K++, K === P) { var X = A, A = []; if ("0" === m) for (m = P - T - (X ? X.length : 0); 0 < m;)X.unshift("0"), m--; for (; 0 < X.length;)r = X.pop() + r, G++, 0 === G % J && (M === W && 0 < X.length) && (r = v + r) } else 0 < A.length ? (r = A.pop() + r, T++, G++) : "0" === m && (r = "0" + r, T++, G++), 0 === G % J && (M === W && 0 < A.length) && (r = v + r); else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (M++, J = G, G = 0, 0 < A.length && (r = v + r)) : r = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + r : m + r : (m = 0 > Q ?
                    m.replace("+", "").replace("-", "") : m.replace("-", ""), r += m.replace(/[0]+/, function (a) { return ba(Q, a.length) })); v = ""; for (O = !1; 0 < V.length;)m = V.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (v += h.shift(), O = !0) : "0" === m && (v += "0", O = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? v += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? v += m : (m = 0 > Q ? m.replace("+", "").replace("-", "") : m.replace("-", ""), v += m.replace(/[0]+/, function (a) {
                        return ba(Q,
                            a.length)
                    })); r += (O ? B : "") + v; return w ? "-" + r : r
        }, Oa = function (h) { var m = 0, r = 0; h = h || window.event; h.offsetX || 0 === h.offsetX ? (m = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (m = h.layerX, r = h.layerY) : (m = h.pageX - h.target.offsetLeft, r = h.pageY - h.target.offsetTop); return { x: m, y: r } }, $a = !0, Ra = window.devicePixelRatio || 1, Na = 1, ma = $a ? Ra / Na : 1, Y = function (h, m, r, w, v, B, A, J, K, O, V, T, P) {
            "undefined" === typeof P && (P = 1); A = A || 0; J = J || "black"; var G = 15 < w - m && 15 < v - r ? 8 : 0.35 * Math.min(w - m, v - r); h.beginPath(); h.moveTo(m, r); h.save(); h.fillStyle =
        ...
        }, ia = function (h) { for (var m = "", r = 0; r < h.length; r++)m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return m }, cb = window && window[ia("mnb`uhno")] && window[ia("mnb`uhno")].href && window[ia("mnb`uhno")].href.indexOf &&
            (-1 !== window[ia("mnb`uhno")].href.indexOf(ia("b`ow`rkr/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gdonqhy/bnl")) || -1 !== window[ia("mnb`uhno")].href.indexOf(ia("gheemd"))), jb = cb && -1 === window[ia("mnb`uhno")].href.indexOf(ia("gheemd")), kb = {
    ...
    G.prototype.setOptions = function (h, m) { if (qa[this._defaultsKey]) { var r = qa[this._defaultsKey], w; for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : m && w in m ? m[w] : r[w]) } else Ha && window.console && console.log("defaults not set") }; G.prototype.get = function (h) {
    ...
    }; G.prototype.remove = function (h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName]; Da(m); var r = m.indexOf(this.options); 0 <= r && m.splice(r, 1) } else delete this.parent.options[this.optionsName]; h && (this.stockChart || this.chart || this).render() }; G.prototype.updateOption = function (h) {
        !qa[this._defaultsKey] && (Ha && window.console) && console.log("defaults not set"); var m = qa[this._defaultsKey], w = {}, v = this[h], B = this._themeOptionsKey,
    ...
    }; G.prototype.removeEventListener = function (h, m) { if (h && m && this._eventListeners[h]) for (var r = this._eventListeners[h], w = 0; w < r.length; w++)if (r[w].eventHandler === m) { r[w].splice(w, 1); break } }; G.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; G.prototype.dispatchEvent = function (h, m, r) {
        ...
        function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ea.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; pa(ka, G); ka.prototype._initialize = function () {
            ...
            h = String(h); if (!h) return { text: "", width: 0 }; var w = r = 0, v = h.length - 1, B = Infinity; for (this.ctx.font = this._getFontString(); w <= v;) {
                ...
                if (r < m) w = B + 1; else if (r > m) v = B - 1; else break
            ...
            var h = new String(Ga(String(this.text))), r = [], w = this.ctx.font, v = 0, B = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) B = v = 0; else for (; 0 < h.length;) {
                var J = this.maxHeight - (this.topPadding +
                    this.bottomPadding), A = this._getLineWithWidth(h, this.maxWidth - (this.leftPadding + this.rightPadding), !1); A.height = this._lineHeight; r.push(A); var G = B, B = Math.max(B, A.width), v = v + A.height, h = Ga(h.slice(A.text.length, h.length)); J && v > J && (A = r.pop(), v -= A.height, B = G)
            } this._wrappedText = { lines: r, width: B, height: v }; this.width = B + (this.leftPadding + this.rightPadding); this.height = v + (this.topPadding + this.bottomPadding); this.ctx.font = w
        ...
        }; pa(Ta, G); pa(ya, G); ya.prototype.setLayout = function () {
            if (this.text) {
                var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(), w = m.x1, v = m.y1, B = 0, J = 0, A = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, G, K; "top" === this.verticalAlign ||
                    "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)), J = 0.5 * m.height - this.margin - 2, B = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4), J = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), J = 0.5 * m.height - 4)); var O; r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !==
                        typeof this.padding || (O = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, O += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : O = 2 * this.padding; this.wrap || (J = Math.min(J, 1.5 * this.fontSize + O)); J = new ka(this.ctx, {
                            ...
                            this.width = O.width, this.height = O.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = m.x1 + 2, v = m.y2 - 2 - (this.maxWidth / 2 - O.width / 2), B = -90, K = "left", this.width = O.height, this.height = O.width) : "right" === this.horizontalAlign ? (w = m.x2 - 2, v = m.y1 + 2 + (this.maxWidth / 2 - O.width / 2), B = 90, K = "right", this.width = O.height, this.height = O.width) : "center" === this.horizontalAlign && (v = h.y1 + (h.height / 2 - O.height / 2), w = h.x1 + (h.width / 2 - O.width / 2), K = "center", this.width = O.width, this.height = O.height), G = "center"); J.x =
                                w; J.y = v; J.angle = B; J.horizontalAlign = G; this._textBlock = J; h.layoutManager.registerSpace(K, { width: this.width + ("left" === K || "right" === K ? this.margin + 2 : 0), height: this.height + ("top" === K || "bottom" === K ? this.margin + 2 : 0) }); this.bounds = { x1: w, y1: v, x2: w + this.width, y2: v + this.height }; this.ctx.textBaseline = "top"
            }
        }; ya.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; pa(Ia, G); Ia.prototype.setLayout = ya.prototype.setLayout; Ia.prototype.render = ya.prototype.render; Ua.prototype.get = function (h, r) {
            var w =
                null; 0 < this.pool.length ? (w = this.pool.pop(), Ma(w, h, r)) : w = ua(h, r); return w
        }; Ua.prototype.release = function (h) { this.pool.push(h) }; pa(Ja, G); var Pa = { addTheme: function (h, r) { bb[h] = r }, addColorSet: function (h, r) { za[h] = r }, addCultureInfo: function (h, r) { Ka[h] = r }, formatNumber: function (h, r, w) { w = w || "en"; if (Ka[w]) return ca(h, r || "#,##0.##", new Ja(w)); throw "Unknown Culture Name"; }, formatDate: function (h, r, w) { w = w || "en"; if (Ka[w]) return Aa(h, r || "DD MMM YYYY", new Ja(w)); throw "Unknown Culture Name"; } }; "undefined" !== typeof module &&
            "undefined" !== typeof module.exports ? module.exports = Pa : "function" === typeof define && define.amd ? define([], function () { return Pa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Pa); B = Pa.Chart = function () {
                function h(a, d) { return a.x - d.x } function m(a, d, c) {
                    ...
                    for (var c = [], b, e = 0; e < a.length; e++)if (0 == e) c.push(a[0]); else {
                        var f, l, t; t = e - 1; f = 0 === t ? 0 : t - 1; l = t === a.length - 1 ? t : t + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[t].x ? 0.01 : a[l].x - a[t].x)) * (d - 1) /
                            2 + 1; var D = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[t].x > a[f].x && 0 < D || a[t].x < a[f].x && 0 > D ? { x: a[t].x + D / 3, y: a[t].y + b / 3 } : { x: a[t].x, y: a[t].y + b / 9 }; t = e; f = 0 === t ? 0 : t - 1; l = t === a.length - 1 ? t : t + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[t].x - a[f].x ? 0.01 : a[t].x - a[f].x)) * (d - 1) / 2 + 1; D = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[t].x > a[f].x && 0 < D || a[t].x < a[f].x && 0 > D ? { x: a[t].x - D / 3, y: a[t].y - b / 3 } : { x: a[t].x, y: a[t].y - b / 9 }; c[c.length] = a[e]
                    } return c
                } function B(a, d, c, b, e, f, l, t, D, k) {
                    var n = 0; k ? (l.color = f, t.color = f) :
                    ...
                    K.base.constructor.call(this, "Legend", "legend", d, null, a); this.chart = a; this.canvas = a.canvas;
                    ...
                    aa.base.constructor.call(this, "Break", d, c, b, f); this.id = e; this.chart = a; this.ctx = this.chart.ctx; this.scaleBreaks = f; this.optionsName =
                ...
                } function ba(a, d, c) { ba.base.constructor.call(this, "Crosshair", "crosshair", d, null, c); this.chart = a; this.ctx = this.chart.ctx; this.axis = c; this.optionsName = "crosshair"; this._thicknessType = "pixel" } function U(a, d) {
                    U.base.constructor.call(this, "ToolTip", "toolTip", d, null, a); this.chart = a; this.canvas = a.canvas; this.ctx = this.chart.ctx; this.currentDataPointIndex = this.currentSeriesIndex = -1; this._prevY = this._prevX =
                ...
                } function Z(a) { this.chart = a; this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.previousDataPointEventObject = null; this.ghostCanvas = ua(this.chart.width, this.chart.height); this.ghostCtx = this.ghostCanvas.getContext("2d"); this.mouseoveredObjectMaps = [] } function ia(a) {
                    this.chart = a; this.ctx = this.chart.plotArea.ctx;
                    this.animations = []; this.animationRequestId = null
                } pa(m, G); m.prototype.destroy = function () {
                        ...
                        za[this.colorSet] : za.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo = new Ja(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && w; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); this.toolbar =
                            new Ta(this, this.options.toolbar); if (this.options.zoomEnabled || this.panEnabled) {
                                if (this._zoomButton) W(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._zoomButton.title = this._cultureInfo.zoomText; else {
                                    var d = !1; va(this._zoomButton = document.createElement("button")); wa(this, this._zoomButton, "pan"); this._zoomButton.title = this._cultureInfo.panText; this._toolBar.appendChild(this._zoomButton);
                                    this._zoomButton.style.borderRight = this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor; P(this._zoomButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers); P(this._zoomButton, "click", function () { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, wa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, wa(a, a._zoomButton, "pan")); a.render() }, this.allDOMEventHandlers); P(this._zoomButton, "mousemove", function () {
                                    ...
                                    }, this.allDOMEventHandlers); P(this._zoomButton, "mouseout", function () {
                                    ...
                                    this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), P(this._resetButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers), P(this._resetButton, "click", function () {
                                        a.toolTip.hide(); a.toolTip && a.toolTip.enabled && a.toolTip.dispatchEvent("hidden", { chart: a, toolTip: a.toolTip }, a.toolTip); a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, wa(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled =
                                            !1); if (a.sessionVariables.axisX) for (var b = 0; b < a.sessionVariables.axisX.length; b++)a.sessionVariables.axisX[b].newViewportMinimum = null, a.sessionVariables.axisX[b].newViewportMaximum = null; if (a.sessionVariables.axisX2) for (b = 0; b < a.sessionVariables.axisX2.length; b++)a.sessionVariables.axisX2[b].newViewportMinimum = null, a.sessionVariables.axisX2[b].newViewportMaximum = null; if (a.sessionVariables.axisY) for (b = 0; b < a.sessionVariables.axisY.length; b++)a.sessionVariables.axisY[b].newViewportMinimum = null, a.sessionVariables.axisY[b].newViewportMaximum =
                                                null; if (a.sessionVariables.axisY2) for (b = 0; b < a.sessionVariables.axisY2.length; b++)a.sessionVariables.axisY2[b].newViewportMinimum = null, a.sessionVariables.axisY2[b].newViewportMaximum = null; a.resetOverlayedCanvas(); 0 >= navigator.userAgent.search("MSIE") && W(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }); va(a._zoomButton, a._resetButton); a.stockChart && (a.stockChart._rangeEventParameter = {
                    ...
                    this.axisX = []; this.axisX2 = []; this.axisY = []; this.axisY2 = []; this._indexLabels = []; this._dataInRenderedOrder = []; this._events = []; this._eventManager && this._eventManager.reset(); this.plotInfo = { axisPlacement: null, plotTypes: [] }; this.layoutManager = new Ea(0, 0, this.width, this.height, this.isNavigator ? 0 : 2); this.plotArea.layoutManager && this.plotArea.layoutManager.reset(); this.data = []; this.title = null; this.subtitles = []; var a = 0, d = null; if (this.options.data) {
                        for (var c = 0; c < this.options.data.length; c++)if (a++, !this.options.data[c].type ||
                            0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
                                var b = new Q(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId); "error" === b.type && (b.linkedDataSeriesIndex = r(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" === this.options.data[b.linkedDataSeriesIndex].type) && (b.linkedDataSeriesIndex = null); null === b.name &&
                ...
                m.prototype.setLayout = function () {
                    ...
                    var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea ||
                        this.legend.render(); if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) A.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var c = []; if (this.animatedRender) { var b = ua(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } ib(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit =
                            3; w && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                                ...
                                D = null; t.targetCanvas && xa(t.targetCanvas); t.targetCanvas = null; this.animatedRender && (t.targetCanvas = ua(this.width, this.height), t.targetCanvasCtx = t.targetCanvas.getContext("2d"), e = t.targetCanvasCtx.miterLimit, t.targetCanvasCtx.miterLimit = 3); "line" === t.type ? D = this.renderLine(t) : "stepLine" === t.type ? D = this.renderStepLine(t) : "spline" === t.type ? D = this.renderSpline(t) : "column" === t.type ? D = this.renderColumn(t) : "bar" === t.type ? D = this.renderBar(t) : "area" === t.type ? D = this.renderArea(t) : "stepArea" === t.type ? D = this.renderStepArea(t) :
                                    "splineArea" === t.type ? D = this.renderSplineArea(t) : "stackedColumn" === t.type ? D = this.renderStackedColumn(t) : "stackedColumn100" === t.type ? D = this.renderStackedColumn100(t) : "stackedBar" === t.type ? D = this.renderStackedBar(t) : "stackedBar100" === t.type ? D = this.renderStackedBar100(t) : "stackedArea" === t.type ? D = this.renderStackedArea(t) : "stackedArea100" === t.type ? D = this.renderStackedArea100(t) : "bubble" === t.type ? D = D = this.renderBubble(t) : "scatter" === t.type ? D = this.renderScatter(t) : "pie" === t.type ? this.renderPie(t) : "doughnut" ===
                                        t.type ? this.renderPie(t) : "funnel" === t.type ? D = this.renderFunnel(t) : "pyramid" === t.type ? D = this.renderFunnel(t) : "candlestick" === t.type ? D = this.renderCandlestick(t) : "ohlc" === t.type ? D = this.renderCandlestick(t) : "rangeColumn" === t.type ? D = this.renderRangeColumn(t) : "error" === t.type ? D = this.renderError(t) : "rangeBar" === t.type ? D = this.renderRangeBar(t) : "rangeArea" === t.type ? D = this.renderRangeArea(t) : "rangeSplineArea" === t.type ? D = this.renderRangeSplineArea(t) : "waterfall" === t.type ? D = this.renderWaterfall(t) : "boxAndWhisker" ===
                                            t.type && (D = this.renderBoxAndWhisker(t)); for (var k = 0; k < t.dataSeriesIndexes.length; k++)this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[k]]); this.animatedRender && (t.targetCanvasCtx.miterLimit = e, D && c.push(D))
                                ...
                                (e = ua(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(e))); var n = this; if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
                    ...
                    } this.attachPlotAreaEventHandlers(); this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || va(this._zoomButton, this._resetButton); this.toolTip._updateToolTip(); this.renderCount++; Ha && (n = this, setTimeout(function () {
                    ...
                    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        ...
                        D = 0, k = !1, n = !1, p; if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                            this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (t.dataPoints[D].x && t.dataPoints[D].x.getTime || "dateTime" === t.xValueType) f = !0; for (D = 0; D < t.dataPoints.length; D++) {
                                "undefined" === typeof t.dataPoints[D].x && (t.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0)); t.dataPoints[D].x.getTime ? (f = !0, b = t.dataPoints[D].x.getTime()) : b = t.dataPoints[D].x; e = t.dataPoints[D].y; b < c.min && (c.min = b); b > c.max && (c.max = b); e < d.min && "number" === typeof e && (d.min = e);
                                e > d.max && "number" === typeof e && (d.max = e); if (0 < D) { if (a.axisX.logarithmic) { var s = b / t.dataPoints[D - 1].x; 1 > s && (s = 1 / s); c.minDiff > s && 1 !== s && (c.minDiff = s) } else s = b - t.dataPoints[D - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s); null !== e && null !== t.dataPoints[D - 1].y && (a.axisY.logarithmic ? (s = e / t.dataPoints[D - 1].y, 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e - t.dataPoints[D - 1].y, 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s))) } if (b < q && !k) null !== e && (p = b); else {
                                    if (!k && (k = !0, 0 < D)) { D -= 2; continue } if (b > g &&
                                        !n) n = !0; else if (b > g && n) continue; t.dataPoints[D].label && (a.axisX.labels[b] = t.dataPoints[D].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e))
                                }
                    ...
                    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                        for (var d =
                            a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], D = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                                var p = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, s = !1, h; if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var da = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                            ...
                            (a < d.viewPortMin && (d.viewPortMin = Math.min(a, D)), a > d.viewPortMax && (d.viewPortMax = a))); for (q in t) t.hasOwnProperty(q) && !isNaN(q) && (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
                    }
                                ...
                                this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, s; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, da = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                                    this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (n.dataPoints[p].x && n.dataPoints[p].x.getTime || "dateTime" === n.xValueType) f = !0; for (p = 0; p < n.dataPoints.length; p++) {
                                        "undefined" === typeof n.dataPoints[p].x && (n.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); n.dataPoints[p].x.getTime ? (f = !0, b = n.dataPoints[p].x.getTime()) : b = n.dataPoints[p].x; e = r(n.dataPoints[p].y) ? null : n.dataPoints[p].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < p) {
                                            ...
                                            if (!q && (q = !0, 0 < p)) { p -= 2; continue } if (b > da && !g) g = !0; else if (b > da && g) continue; n.dataPoints[p].label && (a.axisX.labels[b] =
                                                n.dataPoints[p].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && s < b && (c.viewPortMin = s) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (t = !0), D[b] = D[b] ? D[b] + Math.abs(e) : Math.abs(e))
                                        }
                    ...
                    if (a.dataSeriesIndexes &&
                        !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, D = 0; D < a.dataSeriesIndexes.length; D++) {
                            var k = this.data[a.dataSeriesIndexes[D]], n = 0, p = !1, q = !1, g, s, h; if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var r = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum :
                                a.axisX.logarithmic ? 0 : -Infinity, u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (k.dataPoints[n].x && k.dataPoints[n].x.getTime || "dateTime" === k.xValueType) t = !0; for (n = 0; n < k.dataPoints.length; n++) {
                                    "undefined" === typeof k.dataPoints[n].x && (k.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); k.dataPoints[n].x.getTime ?
                                        (t = !0, b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x; if ((e = k.dataPoints[n].y) && e.length) { f = Math.min.apply(null, e); l = Math.max.apply(null, e); s = !0; for (var y = 0; y < e.length; y++)null === e.k && (s = !1); s && (p || (h = g), g = b) } b < c.min && (c.min = b); b > c.max && (c.max = b); f < d.min && (d.min = f); l > d.max && (d.max = l); 0 < n && (a.axisX.logarithmic ? (s = b / k.dataPoints[n - 1].x, 1 > s && (s = 1 / s), c.minDiff > s && 1 !== s && (c.minDiff = s)) : (s = b - k.dataPoints[n - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s)), e && (null !== e[0] && k.dataPoints[n - 1].y && null !==
                                            k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (s = e[0] / k.dataPoints[n - 1].y[0], 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e[0] - k.dataPoints[n - 1].y[0], 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s)))); if (!(b < r) || p) {
                    ...
                    if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        var t = this.data[a.dataSeriesIndexes[l]], D = 0, k = !1, n = !1, p = b = 0; if ("normal" === t.axisPlacement || "xySwapped" ===
                    ...
                    function a(a, b, c, e) { if (e) return c = Math.pow(Math.min(c * a / b, b / a), 0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), { startValue: a * c, endValue: b / c }; c = 0.2 * Math.min(c - b + a, b - a); 0 >= c && (c = 0.25 * Math.min(b - a, Math.abs(a))); return { startValue: a + c, endValue: b - c } } function d(a) {
                        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                            var b = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, c = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate &&
                                1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, t = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
                                    var h = e.data[a.dataSeriesIndexes[D]]; if (!(4 > h.dataPoints.length)) for (t = 0; t < h.dataPoints.length; t++)if (b && (q = (k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x, q = Math.floor((g - l) / q), g < f[q].min &&
                        ...
                        for (l = 0; l < this.plotInfo.plotTypes.length; l++)for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++)b =
                            f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b); for (l = 0; l < this._axes.length; l++)if (this._axes[l].dataInfo._dataRanges) {
                                var D =
                                    this._axes[l].dataInfo.min; b = (this._axes[l].dataInfo.max + 1 - D) * Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var k = this._axes[l].dataInfo._dataRanges, n, p, f = []; if (this._axes[l].dataInfo.dataPointYPositiveSums) { var q = this._axes[l].dataInfo.dataPointYPositiveSums; n = k; for (t in q) if (q.hasOwnProperty(t) && !isNaN(t) && (p = q[t], !r(p))) { var g = Math.floor((p - D) / b); p < n[g].min && (n[g].min = p); p > n[g].max && (n[g].max = p) } delete this._axes[l].dataInfo.dataPointYPositiveSums } if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                                        q =
                                        this._axes[l].dataInfo.dataPointYNegativeSums; n = k; for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (p = -1 * q[t], r(p) || (g = Math.floor((p - D) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p))); delete this._axes[l].dataInfo.dataPointYNegativeSums
                                    } for (t = 0; t < k.length - 1; t++)if (n = k[t].max, isFinite(n)) for (; t < k.length - 1;)if (D = k[t + 1].min, isFinite(D)) { p = D - n; p > b && f.push({ diff: p, start: n, end: D }); break } else t++; if (this._axes[l].scaleBreaks.customBreaks) for (t = 0; t < this._axes[l].scaleBreaks.customBreaks.length; t++)for (b =
                ...
                m.prototype._dispatchRangeEvent = function (a, d) {
                    ...
                    e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, D = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
                        f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]); for (l = 0; l < k.length; l++) {
                            var p = k[l], f = !1, q = p.convertPixelToValue({ x: a, y: d }), g = p.convertPixelToValue({ x: c, y: b }); if (q > g) var s = g, g = q, q = s; if (p.scaleBreaks) for (s = 0; !f && s < p.scaleBreaks._appliedBreaks.length; s++)f = p.scaleBreaks._appliedBreaks[s].startValue <= q && p.scaleBreaks._appliedBreaks[s].endValue >= g; if (isFinite(p.dataInfo.minDiff)) if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                                (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) D.push(p), n.push({ val1: q, val2: g }), t = !0; else if (!e) { t = !1; break }
                    ...
                    b = 0, e = 0, f = 0, l = f = e = 0, t = 0, D = b = 0, k = 0; for (a = 0; a < this._indexLabels.length; a++) {
                        var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, l = na("indexLabelFontColor", n.dataPoint, n.dataSeries), s = na("indexLabelFontSize", n.dataPoint, n.dataSeries), t = na("indexLabelFontFamily", n.dataPoint, n.dataSeries), D = na("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = na("indexLabelFontWeight", n.dataPoint, n.dataSeries), h = na("indexLabelBackgroundColor", n.dataPoint, n.dataSeries); q = na("indexLabelMaxWidth", n.dataPoint, n.dataSeries);
                        g = na("indexLabelWrap", n.dataPoint, n.dataSeries); var da = na("indexLabelLineDashType", n.dataPoint, n.dataSeries), u = na("indexLabelLineColor", n.dataPoint, n.dataSeries), m = r(n.dataPoint.indexLabelLineThickness) ? r(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, b = 0 < m ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, x = { percent: null, total: null }, z = null; if (0 <= n.dataSeries.type.indexOf("stacked") ||
                            "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) x = this.getPercentAndTotal(n.dataSeries, n.dataPoint); if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) z = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: x.total, percent: x.percent }; var H = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(z) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ?
                                n.dataSeries.indexLabelFormatter(z) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null; if (null !== H && "" !== H) {
                                    var x = na("indexLabelPlacement", n.dataPoint, n.dataSeries), z = na("indexLabelOrientation", n.dataPoint, n.dataSeries), C = na("indexLabelTextAlign", n.dataPoint, n.dataSeries), v = n.direction, e = n.dataSeries.axisX, f = n.dataSeries.axisY, A = !1, h = new ka(d, {
                                        x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: g ? 5 * s : 1.5 * s, angle: "horizontal" ===
                                            z ? 0 : -90, text: H, padding: 0, backgroundColor: h, textAlign: C, fontSize: s, fontFamily: t, fontWeight: k, fontColor: l, fontStyle: D, textBaseline: "middle"
                    ...
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx :
                        d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                                var D = a.dataSeriesIndexes[t], k = this.data[D]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) { var q = J(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = J(p, k.lineThickness); c.setLineDash(g) } var s = k.id; this._eventManager.objectMap[s] = {
                                    objectType: "dataSeries",
                                    dataSeriesIndex: D
                                }; s = V(s); b.strokeStyle = s; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0]; c.strokeStyle = s; var r = !0, u = 0, m, x; c.beginPath(); if (0 < n.length) {
                                    for (var z = !1, u = 0; u < n.length; u++)if (m = n[u].x.getTime ? n[u].x.getTime() : n[u].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || z || r) && (c.stroke(), w && b.stroke()), z =
                                        !0; else {
                                            m = a.axisX.convertValueToPixel(m); x = a.axisY.convertValueToPixel(n[u].y); var H = k.dataPointIds[u]; this._eventManager.objectMap[H] = { id: H, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: u, x1: m, y1: x }; r || z ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(m, x), w && b.lineTo(m, x)) : (c.beginPath(), c.moveTo(m, x), w && (b.beginPath(),
                                                b.moveTo(m, x))), z = r = !1) : (c.lineTo(m, x), w && b.lineTo(m, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(m, x), w && (b.stroke(), b.beginPath(), b.moveTo(m, x)))); l = { x: m, y: x }; u < n.length - 1 && (h !== (n[u].lineColor || s) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(m, x), h = n[u].lineColor || s, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType, c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g)))); if (0 < n[u].markerSize || 0 < k.markerSize) {
                                                    var C = k.getMarkerProperties(u,
                                                        m, x, c); f.push(C); H = V(H); w && f.push({ x: m, y: x, ctx: b, type: C.type, size: C.size, color: H, borderColor: H, borderThickness: C.borderThickness })
                            ...
                            } X.drawMarkers(f); w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
                    ...
                    var d =
                        a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                                var D = a.dataSeriesIndexes[t], k = this.data[D]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) { var q = J(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = J(p, k.lineThickness); c.setLineDash(g) } var s =
                                    k.id; this._eventManager.objectMap[s] = { objectType: "dataSeries", dataSeriesIndex: D }; s = V(s); b.strokeStyle = s; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0]; c.strokeStyle = s; var r = !0, u = 0, m, x; c.beginPath(); if (0 < n.length) {
                                        for (var z = !1, u = 0; u < n.length; u++)if (m = n[u].getTime ? n[u].x.getTime() : n[u].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z))) if ("number" !== typeof n[u].y) 0 <
                                            u && !(k.connectNullData || z || r) && (c.stroke(), w && b.stroke()), z = !0; else {
                                                var H = x; m = a.axisX.convertValueToPixel(m); x = a.axisY.convertValueToPixel(n[u].y); var C = k.dataPointIds[u]; this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: u, x1: m, y1: x }; r || z ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                                    c.lineTo(m, H), c.lineTo(m, x), w && (b.lineTo(m, H), b.lineTo(m, x))) : (c.beginPath(), c.moveTo(m, x), w && (b.beginPath(), b.moveTo(m, x))), z = r = !1) : (c.lineTo(m, H), w && b.lineTo(m, H), c.lineTo(m, x), w && b.lineTo(m, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(m, x), w && (b.stroke(), b.beginPath(), b.moveTo(m, x)))); l = { x: m, y: x }; u < n.length - 1 && (h !== (n[u].lineColor || s) || p !== (n[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(m, x), h = n[u].lineColor || s, c.strokeStyle = h, c.setLineDash && (n[u].lineDashType ? (p = n[u].lineDashType,
                                                        c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g)))); if (0 < n[u].markerSize || 0 < k.markerSize) H = k.getMarkerProperties(u, m, x, c), f.push(H), C = V(C), w && f.push({ x: m, y: x, ctx: b, type: H.type, size: H.size, color: C, borderColor: C, borderThickness: H.borderThickness }); (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: n[u], dataSeries: k, point: { x: m, y: x }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: s })
                                        } c.stroke();
                                        w && b.stroke()
                                    }
                            } X.drawMarkers(f); w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), b.beginPath()); c.restore(); c.beginPath(); return {
                                source: d, dest: this.plotArea.ctx,
                                animationCallback: M.xClipAnimation, easingFunction: M.easing.linear, animationBase: 0
                            }
                        }
                    ...
                    function d(a) {
                        ...
                        var f = this.plotArea; b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                            var D = a.dataSeriesIndexes[t], k = this.data[D]; b.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (b.setLineDash) { var q = J(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = J(p, k.lineThickness); b.setLineDash(g) } var s = k.id; this._eventManager.objectMap[s] = { objectType: "dataSeries", dataSeriesIndex: D }; s = V(s); e.strokeStyle = s; e.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness,
                                4) : 0; var s = k._colorSet, h = s = k.lineColor = k.options.lineColor ? k.options.lineColor : s[0]; b.strokeStyle = s; var r = 0, u, m, x = []; b.beginPath(); if (0 < n.length) for (m = !1, r = 0; r < n.length; r++)if (u = n[r].getTime ? n[r].x.getTime() : n[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m))) if ("number" !== typeof n[r].y) 0 < r && !m && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                                    (d(x), x = [])), m = !0; else {
                                        u = a.axisX.convertValueToPixel(u); m = a.axisY.convertValueToPixel(n[r].y); var z = k.dataPointIds[r]; this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: r, x1: u, y1: m }; x[x.length] = { x: u, y: m }; r < n.length - 1 && (h !== (n[r].lineColor || s) || p !== (n[r].lineDashType || k.lineDashType)) && (h = n[r].lineColor || s, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (n[r].lineDashType ? (p = n[r].lineDashType, x[x.length - 1].newLineDashArray = J(p, k.lineThickness)) : (p = k.lineDashType,
                                            x[x.length - 1].newLineDashArray = g))); if (0 < n[r].markerSize || 0 < k.markerSize) { var H = k.getMarkerProperties(r, u, m, b); l.push(H); z = V(z); w && l.push({ x: u, y: m, ctx: e, type: H.type, size: H.size, color: z, borderColor: z, borderThickness: H.borderThickness }) } (n[r].indexLabel || k.indexLabel || n[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: n[r], dataSeries: k, point: { x: u, y: m }, direction: 0 > n[r].y === a.axisY.reversed ? 1 : -1, color: s }); m = !1
                                } d(x)
                        } X.drawMarkers(l); w && (c.drawImage(this._preRenderCanvas,
                        ...
                        var b = null, e = this.plotArea, f = 0, l, t, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
                            0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff; isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range)); p = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ?
                                this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                                    var q = a.dataSeriesIndexes[n], g = this.data[q], s = g.dataPoints; if (0 < s.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? D = s[f].x.getTime() :
                                        D = s[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                            l = a.axisX.convertValueToPixel(D); t = a.axisY.convertValueToPixel(s[f].y); l = a.axisX.reversed ? l + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : l - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0; var r = a.axisX.reversed ? l - p << 0 : l + p << 0, u; 0 <= s[f].y ? u = k : (u = t, t = k); t > u && (b = t, t = u, u = b); b = s[f].color ? s[f].color : g._colorSet[f % g._colorSet.length]; Y(c, a.axisX.reversed ? r : l, t, a.axisX.reversed ?
                                                l : r, u, b, 0, null, h && (a.axisY.reversed ? 0 > s[f].y : 0 <= s[f].y), (a.axisY.reversed ? 0 <= s[f].y : 0 > s[f].y) && h, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: t, x2: r, y2: u }; b = V(b); w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, t, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1, !1, !1); (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                                    chartType: "column", dataPoint: s[f],
                                                    dataSeries: g, point: { x: l + (r - l) / 2, y: 0 > s[f].y === a.axisY.reversed ? t : u }, direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: l, y1: Math.min(t, u), x2: r, y2: Math.max(t, u) }, color: b
                                                })
                                    }
                                } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                                    0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.yScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k }
                    }
                            ...
                            Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > g && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, g)); !this.dataPointMaxWidth && (this.dataPointMinWidth && g < k) && (g = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); s < k && (s = k); s > g && (s = g); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                                e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                                    var h = a.dataSeriesIndexes[g], r = this.data[h], u = r.dataPoints; if (0 < u.length) {
                                        var m = 5 < s && r.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                            n = a.axisX.convertValueToPixel(b); n = n - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var x = n + s << 0, z; if (a.axisY.logarithmic ||
                                    ...
                                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.yScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
                    }
                    ...
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx :
                        d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                                var h = a.dataSeriesIndexes[g], r = this.data[h], u = r.dataPoints; if (0 < u.length) for (var m = 5 < s && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                    n = a.axisX.convertValueToPixel(b); p = 0 !== a.dataPointYSums[b] ?
                                        100 * (u[k].y / a.dataPointYSums[b]) : 0; n = n - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var x = n + s << 0, z; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) { t[b] = p + ("undefined" !== typeof t[b] ? t[b] : 0); if (0 >= t[b]) continue; p = a.axisY.convertValueToPixel(t[b]); z = f[b] ? f[b] : q; f[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = p + ("undefined" !== typeof D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = l[b] ? l[b] : q, l[b] = z;
                                            ...
                                            m, !1, !1, r.fillOpacity); b = r.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: n, y1: p, x2: x, y2: z }; b = V(b); w && Y(this._eventManager.ghostCtx, n, p, x, z, b, 0, null, !1, !1, !1, !1); (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                source: d,
                                dest: this.plotArea.ctx, animationCallback: M.yScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q
                            }
                        }
                }; m.prototype.renderBar = function (a) {
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                        var b = null, e = this.plotArea, f = 0, l, t, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ?
                                ...
                                Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                                    var q =
                                        a.dataSeriesIndexes[n], g = this.data[q], s = g.dataPoints; if (0 < s.length) {
                                            var h = 5 < p && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < s.length; f++)if (s[f].getTime ? D = s[f].x.getTime() : D = s[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                                t = a.axisX.convertValueToPixel(D); l = a.axisY.convertValueToPixel(s[f].y); t = a.axisX.reversed ? t + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : t - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
                                    ...
                                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.xScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: k < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : k > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : k }
                    }
                        ...
                        c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                            var h = a.dataSeriesIndexes[g], r = this.data[h], u = r.dataPoints; if (0 < u.length) {
                                var m = 5 < s && r.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < u.length; k++)if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                    ...
                                    p = p - a.plotType.plotUnits.length * s / 2 + a.index * s << 0; var x = p + s << 0, z; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (z = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(t[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = u[k].y + (D[b] ? D[b] : 0), n = l[b] ? l[b] : q, l[b] = z = a.axisY.convertValueToPixel(D[b]); else if (n = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                        var H = f[b] ? f[b] : 0; z = q + H; n +=
                                            H; f[b] = H + (n - z)
                                    } else H = l[b] ? l[b] : 0, z = n - H, n = q - H, l[b] = H + (n - z); b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length]; Y(c, a.axisY.reversed ? n : z, p, a.axisY.reversed ? z : n, x, b, 0, null, m, !1, !1, !1, r.fillOpacity); b = r.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: n, y2: x }; b = V(b); w && Y(this._eventManager.ghostCtx, z, p, n, x, b, 0, null, !1, !1, !1, !1); (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.xScaleAnimation, easingFunction: M.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q }
                    }
                    ...
                    c; function b() { H && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(r, z), f.lineTo(H.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(r, z), l.lineTo(H.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(r, u), l.beginPath(), l.moveTo(r, u), H = { x: r, y: u }) } var e = a.targetCanvasCtx || this.plotArea.ctx, f = w ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
                        var l =
                            this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, D = [], k = this.plotArea, n; f.save(); w && l.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); w && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                var q = a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints, D = g.id; this._eventManager.objectMap[D] = { objectType: "dataSeries", dataSeriesIndex: q }; D = V(D); l.fillStyle = D; D = []; d = !0; var h = 0, r, u, m, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                                    a.axisY.viewportMinimum : 0), z, H = null; if (0 < s.length) {
                                            ...
                                            typeof s[h].y) g.connectNullData || (ea || d) || b(), ea = !0; else {
                                                r = a.axisX.convertValueToPixel(m); u = a.axisY.convertValueToPixel(s[h].y); d || ea ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = n.x, u = n.y, b(), f.moveTo(n.x, n.y), r = d, u = c, H = n, c = g.nullDataLineDashType, f.setLineDash(L)), f.lineTo(r, u), w && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), w && (l.beginPath(), l.moveTo(r, u)), H = { x: r, y: u }), ea = d = !1) : (f.lineTo(r, u), w && l.lineTo(r,
                                                    u), 0 == h % 250 && b()); n = { x: r, y: u }; h < s.length - 1 && (A !== (s[h].lineColor || v) || c !== (s[h].lineDashType || g.lineDashType)) && (b(), A = s[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (s[h].lineDashType ? (c = s[h].lineDashType, f.setLineDash(J(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(S)))); var $ = g.dataPointIds[h]; this._eventManager.objectMap[$] = { id: $, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: r, y1: u }; 0 !== s[h].markerSize && (0 < s[h].markerSize || 0 < g.markerSize) && (m = g.getMarkerProperties(h, r,
                                                        u, f), D.push(m), $ = V($), w && D.push({ x: r, y: u, ctx: l, type: m.type, size: m.size, color: $, borderColor: $, borderThickness: m.borderThickness })); (s[h].indexLabel || g.indexLabel || s[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: s[h], dataSeries: g, point: { x: r, y: u }, direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1, color: C })
                                        } b(); X.drawMarkers(D)
                                    }
                    ...
                    function d() {
                        ...
                        var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, l = [], t = this.plotArea; b.save(); w && e.save(); b.beginPath(); b.rect(t.x1, t.y1, t.width, t.height); b.clip(); w && (e.beginPath(), e.rect(t.x1, t.y1, t.width, t.height), e.clip()); for (var h =
                            0; h < a.dataSeriesIndexes.length; h++) {
                                var k = a.dataSeriesIndexes[h], n = this.data[k], p = n.dataPoints, l = n.id; this._eventManager.objectMap[l] = { objectType: "dataSeries", dataSeriesIndex: k }; l = V(l); e.fillStyle = l; var l = [], q = 0, g, s, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, u = null, y = []; if (0 < p.length) {
                                    var x = n._colorSet[q % n._colorSet.length], z = n.lineColor = n.options.lineColor || x, H = z; b.fillStyle = x; b.strokeStyle = z; b.lineWidth = n.lineThickness; var C = "solid"; if (b.setLineDash) {
                                        var A = J(n.nullDataLineDashType,
                                            n.lineThickness), C = n.lineDashType, B = J(C, n.lineThickness); b.setLineDash(B)
                                    } for (s = !1; q < p.length; q++)if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !s))) if ("number" !== typeof p[q].y) 0 < q && !s && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, C = n.nullDataLineDashType) : (d(), y = [])), s = !0; else {
                                        ...
                                        var L = n.dataPointIds[q]; this._eventManager.objectMap[L] = { id: L, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: s }; y[y.length] = { x: g, y: s }; q < p.length - 1 && (H !== (p[q].lineColor || z) || C !== (p[q].lineDashType || n.lineDashType)) && (H = p[q].lineColor || z, y[y.length - 1].newStrokeStyle = H, b.setLineDash && (p[q].lineDashType ? (C = p[q].lineDashType, y[y.length - 1].newLineDashArray = J(C, n.lineThickness)) : (C = n.lineDashType, y[y.length - 1].newLineDashArray = B))); if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) {
                                            var S =
                                                n.getMarkerProperties(q, g, s, b); l.push(S); L = V(L); w && l.push({ x: g, y: s, ctx: e, type: S.type, size: S.size, color: L, borderColor: L, borderThickness: S.borderThickness })
                                        } (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: { x: g, y: s }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: x }); s = !1
                                    } d(); X.drawMarkers(l)
                                }
                        } w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation =
                            "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(t.x1, t.y1, t.width, t.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: M.xClipAnimation, easingFunction: M.easing.linear, animationBase: 0 }
                    }
                }; m.prototype.renderStepArea =
                    function (a) {
                        var d, c; function b() { H && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(m, z), f.lineTo(H.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(m, z), l.lineTo(H.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, u), l.beginPath(), l.moveTo(m, u), H = { x: m, y: u }) } var e = a.targetCanvasCtx || this.plotArea.ctx, f = w ? this._preRenderCtx :
                            e; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var l = this._eventManager.ghostCtx, t = a.axisY.lineCoordinates, h = [], k = this.plotArea, n; f.save(); w && l.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); w && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                    var q = a.dataSeriesIndexes[p], g = this.data[q], s = g.dataPoints, h = g.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: q }; h = V(h); l.fillStyle = h; h = []; d = !0; var r = 0, m, u, y, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                                        a.axisY.viewportMinimum : 0), z, H = null; c = !1; if (0 < s.length) {
                                            var C = g._colorSet[r % g._colorSet.length], v = g.lineColor = g.options.lineColor || C, A = v; f.fillStyle = C; f.strokeStyle = v; f.lineWidth = g.lineThickness; var L = "solid"; if (f.setLineDash) { var S = J(g.nullDataLineDashType, g.lineThickness), L = g.lineDashType, B = J(L, g.lineThickness); f.setLineDash(B) } for (; r < s.length; r++)if (y = s[r].x.getTime ? s[r].x.getTime() : s[r].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                                var $ = u; "number" !==
                        ...
                        function (a) {
                            function d() { if (!(1 > k.length)) { for (0 < C.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); w && m.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = C.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); w && (m.closePath(), m.fill(), m.beginPath()); k = [] } } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var e = null, f = null, l = [], t = this.plotArea, h = [], k = [], n = [], p = [], q = 0, g, s, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                                    0), m = this._eventManager.ghostCtx, u, y, x; w && m.beginPath(); b.save(); w && m.save(); b.beginPath(); b.rect(t.x1, t.y1, t.width, t.height); b.clip(); w && (m.beginPath(), m.rect(t.x1, t.y1, t.width, t.height), m.clip()); for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) { var H = a.dataSeriesIndexes[z], C = this.data[H], v = C.dataPoints; C.dataPointIndexes = []; for (q = 0; q < v.length; q++)H = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[H] = q, e[H] || (n.push(H), e[H] = !0); n.sort(Qa) } for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                                        ...
                                        C = this.data[H]; v = C.dataPoints; y = !0; k = []; q = C.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: H }; q = V(q); m.fillStyle = q; if (0 < n.length) {
                                            var e = C._colorSet[0], A = C.lineColor = C.options.lineColor || e, L = A; b.fillStyle = e; b.strokeStyle = A; b.lineWidth = C.lineThickness; x = "solid"; if (b.setLineDash) { var S = J(C.nullDataLineDashType, C.lineThickness); x = C.lineDashType; var B = J(x, C.lineThickness); b.setLineDash(B) } for (var $ = !0, q = 0; q < n.length; q++) {
                                                var f = n[q], ga = null, ga = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] :
                                                    { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !$))) if ("number" !== typeof ga.y) C.connectNullData || ($ || y) || d(), $ = !0; else {
                                                        g = a.axisX.convertValueToPixel(f); var oa = h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ga.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue; s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ga.y), s -= oa; k.push({ x: g, y: r - oa }); h[f] = r - s; y || $ ? (!y &&
                            ...
                            function d() { for (0 < C.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); w && x.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = C.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); w && (x.closePath(), x.fill(), x.beginPath()); k = [] } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var e = null, f = null, l = this.plotArea, t = [], h = [], k = [], n = [], p = [], q =
                                    0, g, s, r, m, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), x = this._eventManager.ghostCtx; b.save(); w && x.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); w && (x.beginPath(), x.rect(l.x1, l.y1, l.width, l.height), x.clip()); for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                                        var H = a.dataSeriesIndexes[z], C = this.data[H], v = C.dataPoints; C.dataPointIndexes = []; for (q = 0; q < v.length; q++)H = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[H] = q, e[H] || (n.push(H), e[H] =
                                            !0); n.sort(Qa)
                                    } for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                                        H = a.dataSeriesIndexes[z]; C = this.data[H]; v = C.dataPoints; m = !0; e = C.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: H }; e = V(e); x.fillStyle = e; k = []; if (0 < n.length) {
                                            var e = C._colorSet[q % C._colorSet.length], A = C.lineColor = C.options.lineColor || e, L = A; b.fillStyle = e; b.strokeStyle = A; b.lineWidth = C.lineThickness; u = "solid"; if (b.setLineDash) { var S = J(C.nullDataLineDashType, C.lineThickness); u = C.lineDashType; var B = J(u, C.lineThickness); b.setLineDash(B) } for (var $ =
                                                !0, q = 0; q < n.length; q++) {
                                                    var f = n[q], ga = null, ga = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !$))) if ("number" !== typeof ga.y) C.connectNullData || ($ || m) || d(), $ = !0; else {
                                                        var oa; oa = 0 !== a.dataPointYSums[f] ? 100 * (ga.y / a.dataPointYSums[f]) : 0; g = a.axisX.convertValueToPixel(f); var la = h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                                            p[f] = oa + (p[f] ? p[f] : 0);
                                                            if (0 >= p[f] && a.axisY.logarithmic) continue; s = a.axisY.convertValueToPixel(p[f])
                                                        } else s = a.axisY.convertValueToPixel(oa), s -= la; k.push({ x: g, y: y - la }); h[f] = y - s; m || $ ? (!m && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (m = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(m), u = C.nullDataLineDashType, b.setLineDash(S)), b.lineTo(g, s), w && x.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (x.beginPath(), x.moveTo(g, s))), $ = m =
                                                            !1) : (b.lineTo(g, s), w && x.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && x.moveTo(g, s), k.push({ x: g, y: y - la }))); r = { x: g, y: s }; q < v.length - 1 && (L !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({ x: g, y: y - la }), L = v[q].lineColor || A, b.strokeStyle = L, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(J(u, C.lineThickness))) : (u = C.lineDashType, b.setLineDash(B)))); if (0 <= C.dataPointIndexes[f]) {
                                                                var F = C.dataPointIds[C.dataPointIndexes[f]]; this._eventManager.objectMap[F] =
                                                                    { id: F, objectType: "dataPoint", dataSeriesIndex: H, dataPointIndex: C.dataPointIndexes[f], x1: g, y1: s }
                                                            } 0 <= C.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < C.markerSize) && (la = C.getMarkerProperties(q, g, s, b), t.push(la), f = V(F), w && t.push({ x: g, y: s, ctx: x, type: la.type, size: la.size, color: f, borderColor: f, borderThickness: la.borderThickness })); (ga.indexLabel || C.indexLabel || ga.indexLabelFormatter || C.indexLabelFormatter) && this._indexLabels.push({
                                                                chartType: "stackedArea100", dataPoint: ga, dataSeries: C, point: {
                                                                    x: g,
                                                                    y: s
                                                                }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e
                                                            })
                                                    }
                                            } d(); b.moveTo(g, s); w && x.moveTo(g, s)
                                        } delete C.dataPointIndexes
                                    } X.drawMarkers(t); w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
                                        b.clearRect(l.x1, l.y1, l.width, l.height), x.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: M.xClipAnimation, easingFunction: M.easing.linear, animationBase: 0 }
                            }
                            ...
                            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var b = this.plotArea, e = 0, f, l; c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(),
                                    this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var t = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > t && (t = g), g < h && (h = g)); for (var s = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI,
                                        s), k = 0; k < a.dataSeriesIndexes.length; k++)if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                            f = a.axisX.convertValueToPixel(f); l = a.axisY.convertValueToPixel(q[e].y); var g = q[e].z, m = 2 * Math.max(Math.sqrt((t === h ? r / 2 : s + (r - s) / (t - h) * (g - h)) / Math.PI) << 0, 1), g = p.getMarkerProperties(e, c); g.size = m; c.globalAlpha =
                                                p.fillOpacity; X.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; var u = p.dataPointIds[e]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: l, size: m }; m = V(u); w && X.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, m, m, g.borderThickness); (q[e].indexLabel || p.indexLabel || q[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                            }
                            ...
                            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var b = this.plotArea, e = 0, f, l; c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1,
                                    b.width, b.height), this._eventManager.ghostCtx.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                                        ...
                                        this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                            }
                            ...
                            var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
                                ...
                                this.dataPointMaxWidth && e > f && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f)); !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); s < e && (s = e); s > f && (s = f); c.save(); w && b.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); w && (b.beginPath(), b.rect(l.x1, l.y1, l.width, l.height), b.clip()); for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                                    var da = a.dataSeriesIndexes[m], u = this.data[da], y = u.dataPoints;
                                    if (0 < y.length) for (var x = 5 < s && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)if (y[t].getTime ? g = y[t].x.getTime() : g = y[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] && "number" === typeof y[t].y[1] && "number" === typeof y[t].y[2] && "number" === typeof y[t].y[3]) {
                                        h = a.axisX.convertValueToPixel(g); k = a.axisY.convertValueToPixel(y[t].y[0]); n = a.axisY.convertValueToPixel(y[t].y[1]); p = a.axisY.convertValueToPixel(y[t].y[2]); q = a.axisY.convertValueToPixel(y[t].y[3]);
                                        var z = h - s / 2 << 0, H = z + s << 0, f = u.options.fallingColor ? u.fallingColor : u._colorSet[0], e = y[t].color ? y[t].color : u._colorSet[0], C = Math.round(Math.max(1, 0.15 * s)), v = 0 === C % 2 ? 0 : 0.5, A = u.dataPointIds[t]; this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: da, dataPointIndex: t, x1: z, y1: k, x2: H, y2: n, x3: h, y3: p, x4: h, y4: q, borderThickness: C, color: e }; c.strokeStyle = e; c.beginPath(); c.lineWidth = C; b.lineWidth = Math.max(C, 4); "candlestick" === u.type ? (c.moveTo(h - v, n), c.lineTo(h - v, Math.min(k, q)), c.stroke(), c.moveTo(h -
                                            v, Math.max(k, q)), c.lineTo(h - v, p), c.stroke(), Y(c, z, Math.min(k, q), H, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, C, e, x, x, !1, !1, u.fillOpacity), w && (e = V(A), b.strokeStyle = e, b.moveTo(h - v, n), b.lineTo(h - v, Math.min(k, q)), b.stroke(), b.moveTo(h - v, Math.max(k, q)), b.lineTo(h - v, p), b.stroke(), Y(b, z, Math.min(k, q), H, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - v, n), c.lineTo(h - v, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(z, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(H, q), c.stroke(),
                                                w && (e = V(A), b.strokeStyle = e, b.moveTo(h - v, n), b.lineTo(h - v, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(z, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(H, q), b.stroke())); (y[t].indexLabel || u.indexLabel || y[t].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({ chartType: u.type, dataPoint: y[t], dataSeries: u, point: { x: z + (H - z) / 2, y: a.axisY.reversed ? p : n }, direction: 1, bounds: { x1: z, y1: Math.min(n, p), x2: H, y2: Math.max(n, p) }, color: e })
                                    }
                ...
                m.prototype.renderBoxAndWhisker = function (a) {
                    var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        s = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(s) / Math.log(a.axisX.range) : Math.abs(s) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > l && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < e) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); s < e && (s = e); s > l && (s = l); c.save(); w && b.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); w && (b.beginPath(),
                            b.rect(f.x1, f.y1, f.width, f.height), b.clip()); for (var m = !1, m = !!a.axisY.reversed, da = 0; da < a.dataSeriesIndexes.length; da++) {
                                var u = a.dataSeriesIndexes[da], y = this.data[u], x = y.dataPoints; if (0 < x.length) for (var z = 5 < s && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] &&
                                    "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                        t = a.axisX.convertValueToPixel(g); h = a.axisY.convertValueToPixel(x[l].y[0]); k = a.axisY.convertValueToPixel(x[l].y[1]); n = a.axisY.convertValueToPixel(x[l].y[2]); p = a.axisY.convertValueToPixel(x[l].y[3]); q = a.axisY.convertValueToPixel(x[l].y[4]); var v = t - s / 2 << 0, C = t + s / 2 << 0, e = x[l].color ? x[l].color : y._colorSet[0], A = Math.round(Math.max(1, 0.15 * s)), B = 0 === A % 2 ? 0 : 0.5, L = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ?
                                ...
                                c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), b.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                    }
                    ...
                    function (a) {
                                            ...
                                            b = a.axisX.convertValueToPixel(h); l =
                                                a.axisY.convertValueToPixel(g[f].y[0]); t = a.axisY.convertValueToPixel(g[f].y[1]); var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + n) * k << 0, da = a.axisX.reversed ? m - k << 0 : m + k << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length]; if (l > t) { var u = l; l = t; t = u } u = q.dataPointIds[f]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: m, y1: l, x2: da, y2: t }; Y(c, a.axisX.reversed ?
                                                    da : m, l, a.axisX.reversed ? m : da, t, b, 0, b, s, s, !1, !1, q.fillOpacity); b = V(u); w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? da : m, l, a.axisX.reversed ? m : da, t, b, 0, null, !1, !1, !1, !1); if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: m + (da - m) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: m, y1: Math.min(l, t), x2: da, y2: Math.max(l, t) }, color: b }), this._indexLabels.push({
                                                        ...
                                                        dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: m + (da - m) / 2, y: g[f].y[1] >= g[f].y[0] ? l : t }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: m, y1: Math.min(l, t), x2: da, y2: Math.max(l, t) }, color: b
                                                    })
                                        }
                                    } w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                                        0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                        }
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                            ...
                            t = 0, h, k, n, p, q, g, s, m = a.axisX.dataInfo.minDiff; isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range)); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.clip()); for (var da = 0, u = 0; u < this.data.length; u++)!this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && da || da++; for (var y =
                                0; y < a.dataSeriesIndexes.length; y++) {
                                    var x = a.dataSeriesIndexes[y], z = this.data[x], v = z.dataPoints, C = r(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1, A = 0; if (C) for (e = z._linkedSeries.id, u = 0; u < e; u++)!this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && A || (this.data[u].type.match(/(range)/ig) && (f = !0), A++); e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                                        1; t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? da : 1))) << 0 : 0.3 * this.width; f && (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? da : 1))) << 0 : 0.03 * this.width); u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) :
                                            Math.abs(m) / Math.abs(a.axisX.range)) / (C ? da : 1)) << 0; this.dataPointMaxWidth && e > t && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, t)); !this.dataPointMaxWidth && (this.dataPointMinWidth && t < e) && (t = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); u < e && (u = e); u > t && (u = t); if (0 < v.length) for (var E = z._colorSet, t = 0; t < v.length; t++) {
                                                var e = z.lineColor = z.options.color ? z.options.color : E[0], L = {
                                                    color: v[t].whiskerColor ? v[t].whiskerColor : v[t].color ? z.whiskerColor ? z.whiskerColor :
                                                        v[t].color : z.whiskerColor ? z.whiskerColor : e, thickness: r(v[t].whiskerThickness) ? z.whiskerThickness : v[t].whiskerThickness, dashType: v[t].whiskerDashType ? v[t].whiskerDashType : z.whiskerDashType, length: r(v[t].whiskerLength) ? r(z.options.whiskerLength) ? u : z.options.whiskerLength : v[t].whiskerLength, trimLength: r(v[t].whiskerLength) ? r(z.options.whiskerLength) ? 50 : 0 : 0
                                                    ...
                                                    u / 100 > u : u; L.thickness = "number" === typeof L.thickness ? 0 > L.thickness ? 0 : Math.round(L.thickness) : 2; var S = { color: v[t].stemColor ? v[t].stemColor : v[t].color ? z.stemColor ? z.stemColor : v[t].color : z.stemColor ? z.stemColor : e, thickness: v[t].stemThickness ? v[t].stemThickness : z.stemThickness, dashType: v[t].stemDashType ? v[t].stemDashType : z.stemDashType }; S.thickness = "number" === typeof S.thickness ? 0 > S.thickness ? 0 : Math.round(S.thickness) : 2; v[t].getTime ? s = v[t].x.getTime() : s = v[t].x; if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) &&
                                                        !r(v[t].y) && v[t].y.length && "number" === typeof v[t].y[0] && "number" === typeof v[t].y[1]) {
                                                            var ea = a.axisX.convertValueToPixel(s); b ? k = ea : h = ea; ea = a.axisY.convertValueToPixel(v[t].y[0]); b ? n = ea : q = ea; ea = a.axisY.convertValueToPixel(v[t].y[1]); b ? p = ea : g = ea; b ? (q = a.axisX.reversed ? k + (C ? da : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : k - (C ? da : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (n = a.axisX.reversed ? h + (C ? da : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : h - (C ? da : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? n - u << 0 : n + u << 0); !b && q > g && (ea = q, q = g, g = ea); b &&
                                                                n > p && (ea = n, n = p, p = ea); ea = z.dataPointIds[t]; this._eventManager.objectMap[ea] = { id: ea, objectType: "dataPoint", dataSeriesIndex: x, dataPointIndex: t, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: S, whiskerProperties: L }; B(c, Math.min(n, p), Math.min(q, g), Math.max(p, n), Math.max(g, q), e, L, S, b); w && B(this._eventManager.ghostCtx, n, q, p, g, e, L, S, b); if (v[t].indexLabel || z.indexLabel || v[t].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({
                                                                    chartType: "error",
                                                                    dataPoint: v[t], dataSeries: z, indexKeyword: 0, point: { x: b ? v[t].y[1] >= v[t].y[0] ? n : p : n + (p - n) / 2, y: b ? q + (g - q) / 2 : v[t].y[1] >= v[t].y[0] ? g : q }, direction: v[t].y[1] >= v[t].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b
                                                                }), this._indexLabels.push({
                                                                    chartType: "error", dataPoint: v[t], dataSeries: z, indexKeyword: 1, point: { x: b ? v[t].y[1] >= v[t].y[0] ? p : n : n + (p - n) / 2, y: b ? q + (g - q) / 2 : v[t].y[1] >= v[t].y[0] ? q : g }, direction: v[t].y[1] >= v[t].y[0] ? 1 : -1, bounds: {
                                                                        x1: b ?
                                ...
                                l.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                        }
                        ...
                        function d() {
                            if (y) {
                                ...
                                } b.beginPath(); b.moveTo(s, r); e.beginPath(); e.moveTo(s, r); y = { x: s, y: r }; h = []; h.push({ x: s, y1: r, y2: m })
                            }
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); w && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); w && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                                ...
                                n = this.data[k], p = n.dataPoints, f = n.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = V(f); e.fillStyle = f; var f = [], q = !0, g = 0, s, r, m, u, y = null; if (0 < p.length) {
                                    var x = n._colorSet[g % n._colorSet.length], v = n.lineColor = n.options.lineColor || x, A = v; b.fillStyle = x; b.strokeStyle = v; b.lineWidth = n.lineThickness; var C = "solid"; if (b.setLineDash) { var B = J(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType, E = J(C, n.lineThickness); b.setLineDash(E) } for (var L = !0; g < p.length; g++)if (u = p[g].x.getTime ?
                                        p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !L))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                            s = a.axisX.convertValueToPixel(u); r = a.axisY.convertValueToPixel(p[g].y[0]); m = a.axisY.convertValueToPixel(p[g].y[1]); q || L ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, C = n.nullDataLineDashType,
                                                b.setLineDash(B)), b.lineTo(s, r), w && e.lineTo(s, r), h.push({ x: s, y1: r, y2: m })) : (b.beginPath(), b.moveTo(s, r), y = { x: s, y: r }, h = [], h.push({ x: s, y1: r, y2: m }), w && (e.beginPath(), e.moveTo(s, r))), L = q = !1) : (b.lineTo(s, r), h.push({ x: s, y1: r, y2: m }), w && e.lineTo(s, r), 0 == g % 250 && d()); u = n.dataPointIds[g]; this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: s, y1: r, y2: m }; g < p.length - 1 && (A !== (p[g].lineColor || v) || C !== (p[g].lineDashType || n.lineDashType)) && (d(), A = p[g].lineColor || v, h[h.length -
                                                    1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (p[g].lineDashType ? (C = p[g].lineDashType, h[h.length - 1].newLineDashArray = J(C, n.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (C = n.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E)))); if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                                                        var S = n.getMarkerProperties(g, s, m, b); f.push(S); var ea = V(u); w && f.push({ x: s, y: m, ctx: e, type: S.type, size: S.size, color: ea, borderColor: ea, borderThickness: S.borderThickness }); S = n.getMarkerProperties(g,
                                                            s, r, b); f.push(S); ea = V(u); w && f.push({ x: s, y: r, ctx: e, type: S.type, size: S.size, color: ea, borderColor: ea, borderThickness: S.borderThickness })
                                                        ...
                                                        chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 1, point: { x: s, y: m }, direction: p[g].y[0] >
                                                            p[g].y[1] === a.axisY.reversed ? 1 : -1, color: x
                                                    })
                                        } else L || q || d(), L = !0; d(); X.drawMarkers(f)
                                }
                            } w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore());
                            b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: M.xClipAnimation, easingFunction: M.easing.linear, animationBase: 0 }
                        }
                        ...
                        function d(a, c) {
                            ...
                            this.plotArea.ctx, b = w ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); w && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); w && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                                    var h = a.dataSeriesIndexes[t], k = this.data[h], n = k.dataPoints, f = k.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: h }; f = V(f); e.fillStyle = f; var f = [], p = 0, q,
                                        g, s, r = [], m = []; if (0 < n.length) {
                                                ...
                                                typeof n[p].y[1]) {
                                                    q = a.axisX.convertValueToPixel(q); g = a.axisY.convertValueToPixel(n[p].y[0]); s = a.axisY.convertValueToPixel(n[p].y[1]); var B = k.dataPointIds[p]; this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: p, x1: q, y1: g, y2: s }; r[r.length] = { x: q, y: g }; m[m.length] = { x: q, y: s }; p < n.length - 1 && (x !== (n[p].lineColor || y) || z !== (n[p].lineDashType || k.lineDashType)) && (x = n[p].lineColor || y, r[r.length - 1].newStrokeStyle = x, b.setLineDash && (n[p].lineDashType ? (z = n[p].lineDashType,
                                                        r[r.length - 1].newLineDashArray = J(z, k.lineThickness)) : (z = k.lineDashType, r[r.length - 1].newLineDashArray = A))); if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) { var G = k.getMarkerProperties(p, q, g, b); f.push(G); var L = V(B); w && f.push({ x: q, y: g, ctx: e, type: G.type, size: G.size, color: L, borderColor: L, borderThickness: G.borderThickness }); G = k.getMarkerProperties(p, q, s, b); f.push(G); L = V(B); w && f.push({ x: q, y: s, ctx: e, type: G.type, size: G.size, color: L, borderColor: L, borderThickness: G.borderThickness }) } if (n[p].indexLabel ||
                                                            k.indexLabel || n[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: n[p].y[0] <= n[p].y[1] ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: s }, direction: n[p].y[0] <= n[p].y[1] ? 1 : -1, color: u }); g = !1
                                            } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (r[r.length -
                                                1].newLineDashArray = C, z = k.nullDataLineDashType) : (d(A, y), r = [], m = [])), g = !0; d(A, y); X.drawMarkers(f)
                                        }
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = w ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, t, h, k, n, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                                this.options.dataPointWidth ? this.dataPointWidth : 1; h = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0; var q = a.axisX.dataInfo.minDiff; isFinite(q) || (q = 0.3 * Math.abs(a.axisX.range)); q = this.options.dataPointWidth ? this.dataPointWidth : 0.6 * (f.width * (a.axisX.logarithmic ? Math.log(q) / Math.log(a.axisX.range) : Math.abs(q) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth &&
                                    l > h && (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, h)); !this.dataPointMaxWidth && (this.dataPointMinWidth && h < l) && (h = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l)); q < l && (q = l); q > h && (q = h); c.save(); w && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); w && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.clip()); for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                                                ...
                                                t = a.axisX.convertValueToPixel(n); h = 0 === r.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSum); k = 0 === r.dataPointEOs[l].cumulativeSumYStartValue ? p : a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSumYStartValue); t = a.axisX.reversed ? t + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : t - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount +
                                                    g) * q << 0; var E = a.axisX.reversed ? t - q << 0 : t + q << 0; h > k && (e = h, h = k, k = e); a.axisY.reversed && (e = h, h = k, k = e); e = r.dataPointIds[l]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: l, x1: t, y1: h, x2: E, y2: k }; var L = m[l].color ? m[l].color : 0 < m[l].y ? r.risingColor : r.fallingColor; Y(c, a.axisX.reversed ? E : t, a.axisY.reversed ? k : h, a.axisX.reversed ? t : E, a.axisY.reversed ? h : k, L, 0, L, x, x, !1, !1, r.fillOpacity); e = V(e); w && Y(this._eventManager.ghostCtx, a.axisX.reversed ? E : t, h, a.axisX.reversed ? t : E,
                                                        k, e, 0, null, !1, !1, !1, !1); var S, L = t; S = "undefined" !== typeof m[l].isIntermediateSum && !0 === m[l].isIntermediateSum || "undefined" !== typeof m[l].isCumulativeSum && !0 === m[l].isCumulativeSum ? 0 < m[l].y ? h : k : 0 < m[l].y ? k : h; 0 < l && A && (!v || r.connectNullData) && (v && c.setLineDash && c.setLineDash(J(B, u)), c.beginPath(), c.moveTo(A, C - y), c.lineTo(L, S - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A, C - y), b.lineTo(L, S - y), 0 < u && b.stroke())); v = !1; A = E; C = 0 < m[l].y ? h : k; L = m[l].lineDashType ? m[l].lineDashType : r.options.lineDashType ? r.options.lineDashType :
                                                            "shortDash"; c.strokeStyle = m[l].lineColor ? m[l].lineColor : r.options.lineColor ? r.options.lineColor : "#9e9e9e"; c.lineWidth = u; c.setLineDash && (L = J(L, u), c.setLineDash(L)); (m[l].indexLabel || r.indexLabel || m[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: m[l], dataSeries: r, point: { x: t + (E - t) / 2, y: 0 <= m[l].y ? h : k }, direction: 0 > m[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: t, y1: Math.min(h, k), x2: E, y2: Math.max(h, k) }, color: e })
                                            }
                                        ...
                                        0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                                            source: d, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad,
                                            animationBase: 0
                                        }
                        }
                        ...
                        function d() {
                                            ...
                                            k._colorSet.length]; h.indexLabelLineThickness = r(f.indexLabelLineThickness) ? k.indexLabelLineThickness : f.indexLabelLineThickness; h.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : k.indexLabelLineDashType; h.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor : k.indexLabelFontColor; h.indexLabelFontStyle = f.indexLabelFontStyle ? f.indexLabelFontStyle : k.indexLabelFontStyle; h.indexLabelFontWeight = f.indexLabelFontWeight ? f.indexLabelFontWeight : k.indexLabelFontWeight; h.indexLabelFontSize =
                                                r(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize; h.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : k.indexLabelFontFamily; h.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor; h.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * q.width; h.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ?
                                                    f.indexLabelWrap : k.indexLabelWrap; h.indexLabelTextAlign = f.indexLabelTextAlign ? f.indexLabelTextAlign : k.indexLabelTextAlign ? k.indexLabelTextAlign : "left"; h.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 * Math.PI : 0 : g[e - 1].endAngle; h.startAngle = (h.startAngle + 2 * Math.PI) % (2 * Math.PI); h.endAngle = h.startAngle + 2 * Math.PI / z * Math.abs(f.y); f = (h.endAngle + h.startAngle) / 2; f = (f + 2 * Math.PI) % (2 * Math.PI); h.midAngle = f; if (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) { if (0 === a || g[c].midAngle > h.midAngle) c = e; a++ } else if (h.midAngle >
                                                        3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) { if (0 === b || g[d].midAngle > h.midAngle) d = e; b++ } h.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; h.indexLabelTextBlock = new ka(m.plotArea.ctx, {
                                ...
                                q.y1, q.width, q.height); b.fillStyle = m.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < n.length; b++) {
                                    var c = g[b].startAngle, d = g[b].endAngle; if (d > c) {
                                        var e = 0.07 * C * Math.cos(g[b].midAngle), f = 0.07 * C * Math.sin(g[b].midAngle), l = !1; if (n[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (x.x + e)) || 1E-9 < Math.abs(g[b].center.y - (x.y + f))) g[b].center.x = x.x + e * a, g[b].center.y = x.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - x.x) || 0 < Math.abs(g[b].center.y - x.y)) g[b].center.x = x.x + e * (1 - a), g[b].center.y = x.y + f * (1 - a),
                                            l = !0; l && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e])); qa(m.plotArea.ctx, g[b].center, g[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                                    }
                            ...
                            d = (d || 0) + 1; if (1E3 < d) return 0; c = c || 0; var l = 0,
                                k = x.y - 1 * w, h = x.y + 1 * w; if (0 <= a && a < n.length) {
                                ...
                                if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && C - d <= B) l = !1; l && (C -= d); d = 0; if ("inside" !== k.indexLabelPlacement) {
                                    w = C * v; for (a = 0; a < n.length; a++) {
                                        ...
                                        var h = g[a], u = e(a); if (null !== u) {
                                            t = g[a]; r = g[u]; var z = 0, z = b(t, r) - s; if (0 > z) {
                                                for (var A = r = 0, H = 0; H < n.length; H++)H !== a && g[H].hemisphere === h.hemisphere && (g[H].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : A++); r = z / (r + A || 1) * A; var A = -1 * (z - r), J = H = 0; "right" === h.hemisphere ? (H = f(a, r), A = -1 * (z - H), J = f(u, A), +J.toFixed(y) <
                                        ...
                                        2 - x.y) < C) && (u /= Math.abs(Math.cos(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u)), u = u = 0, 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (u = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5), u *= -1) : u = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5), 0 < u && (!l && h.indexLabelText && (r = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, u * r) && f(a, 2 * r)), Math.abs(h.indexLabelTextBlock.x - x.x) < C && (u /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < u && (u *= 0.3), u > d && (d = u))); var G = function (a,
                                            b, c) { for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + n.length) % n.length); d.sort(function (a, b) { return a.y - b.y }); for (b = 0; b < d.length; b++)if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText(); else break }; (function () {
                                                for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++)if (f = !1, t = g[k], t.indexLabelText) {
                                                    var l = e(k); if (null !== l) {
                                                        var h = g[l]; z = 0; z = b(t, h); var q; if (q = 0 > z) {
                                                            q = t.indexLabelTextBlock.x; var r = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height /
                                                                2, s = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2, m = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, u = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width, D = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2; q = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || r > D + p || s < m - p ? !1 : !0
                                                        } q ? (0 > a && (a = k), l !== a && (c = l, d += -z), 0 === k % Math.max(n.length / 10, 3) && (f = !0)) : f = !0; f && (0 < d && 0 <= a && 0 <= c) && (G(d, a, c), c = a = -1, d = 0)
                                                    }
                                                } 0 < d && G(d, a, c)
                                            })()
                            }
                                ...
                                this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, s = 2, w, v = 1.3, u = 20 / 180 * Math.PI, y = 6, x = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, z = 0; a = !1; for (var A = 0; A < n.length; A++)z += Math.abs(n[A].y), !a && ("undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[A].label && null !== n[A].label && 0 < n[A].label.toString().length) && (a = !0); if (0 !== z) {
                                    ...
                                    var C = "inside" !== k.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2; k.radius && (C = Sa(k.radius, C)); var B = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Sa(k.innerRadius, C) : 0.7 * C; k.radius = C; "doughnut" === k.type && (k.innerRadius = B); var E = Math.min(B / C, (C - 1) / C); this.pieDoughnutClickHandler = function (a) {
                                        ...
                                        var b = m.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = m.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
                                            ...
                                            f = !1; e > b && (e = b, f = !0); var l = n[c].color ? n[c].color : k._colorSet[c % k._colorSet.length]; e > d && qa(m.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius); if (f) break
                ...
                var sa = function (a, d, c, b) { "undefined" === typeof c && (c = 1); 0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3), Math.round(d.y3)), a.lineTo(Math.round(d.x4), Math.round(d.y4)), "undefined" !== d.x5 && (a.lineTo(Math.round(d.x5), Math.round(d.y5)), a.lineTo(Math.round(d.x6), Math.round(d.y6))), a.closePath(), a.fillStyle = b ? b : d.color, a.fill(), a.globalAplha = 1, a.restore()) }; m.prototype.renderFunnel =
                    function (a) {
                        function d() { for (var a = 0, b = [], c = 0; c < y.length; c++) { if ("undefined" === typeof y[c].y) return -1; y[c].y = "number" === typeof y[c].y ? y[c].y : 0; a += Math.abs(y[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < y.length; c++)b.push(Math.abs(y[c].y) * E / a); return b } function c() {
                            var a = T, b = W, c = N, d = X, e, f; e = $; f = O - Q; d = Math.abs((f - e) * (b - a + (d - c)) / 2); c = X - N; e = f - e; f = c * (f - O); f = Math.abs(f); f = d + f; for (var d = [], g = 0, k = 0; k < y.length; k++) { if ("undefined" === typeof y[k].y) return -1; y[k].y = "number" === typeof y[k].y ? y[k].y : 0; g += Math.abs(y[k].y) } if (0 ===
                            ...
                            if (u && y) {
                                for (var a, b, c, d, e, f, k, l, h, n, p, q, t, s, m, D = [], x = [], v = { percent: null, total: null }, z = null, C = 0; C < y.length; C++)m =
                                    R[C], m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = g(m).x2 + 1, D[C] = K - m - V; m = 0.5 * V; for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                                        b = u.reversed ? y[B] : y[C]; a = b.color ? b.color : u.reversed ? u._colorSet[(y.length - 1 - C) % u._colorSet.length] : u._colorSet[C % u._colorSet.length]; c = b.indexLabelPlacement || u.indexLabelPlacement || "outside"; s = b.indexLabelTextAlign || u.indexLabelTextAlign || "left"; d = b.indexLabelBackgroundColor || u.indexLabelBackgroundColor || (w ? "transparent" : null); e = b.indexLabelFontColor || u.indexLabelFontColor ||
                            ...
                            function a(b, c) {
                                ...
                                var a, d, e, f, g = 0, l; f = (O - $ + 2 * z) / n; l = n; for (var k, h = 1; h < l; h++) {
                                    e = h * f; for (var t = I.length - 1; 0 <= t; t--)!I[t].isDirty && (I[t].textBlock.y < e && I[t].textBlock.y + I[t].height > e) && (k = q(t), !(k >= I.length - 1) && I[t].textBlock.y + I[t].height + ca > I[k].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y +
                                ...
                                var e = [], f = 0, g = 0; for (a = Math.abs(a); d <=
                                    b; d++)e.push(R[d]); e.sort(function (a, b) { return a.height - b.height }); for (d = 0; d < e.length; d++)if (b = e[d], f < a) g++, f += I[b.id].height + ca, I[b.id].textBlock.text = "", I[b.id].indexLabelText = "", I[b.id].isDirty = !0, I[b.id].textBlock.measureText(); else break; return g
                        ...
                        } function h(a, b) { return (b < R.length ? I[b].textBlock.y : u.reversed ? U + z : ta + z) - (0 > a ? u.reversed ? ta - z : U - z : I[a].textBlock.y + I[a].height + ca) } function m(a, b, c) {
                            var d, e, g, l = [], h = z, p = []; -1 !== b && (0 <= Z.indexOf(b) ? (e = Z.indexOf(b), Z.splice(e, 1)) : (Z.push(b), Z = Z.sort(function (a, b) { return a - b }))); if (0 === Z.length) l = ia; else {
                                e = z * (1 != Z.length || 0 != Z[0] && Z[0] != R.length - 1 ? 2 : 1) / k(); for (var t = 0; t < R.length; t++) {
                                    if (1 == Z.length && 0 == Z[0]) { if (0 === t) { l.push(ia[t]); d = h; continue } } else 0 ===
                                        t && (d = -1 * h); l.push(ia[t] + d); if (0 <= Z.indexOf(t) || t < R.length && 0 <= Z.indexOf(t + 1)) d += e
                                }
                        ...
                        function p(a) { for (a -= 1; -1 <= a && -1 != a && I[a].isDirty; a--); return a } function q(a) { for (a += 1; a <= R.length && a != R.length && I[a].isDirty; a++); return a } function g(a) { for (var b, c = 0; c < y.length; c++)if (R[c].y1 < a && R[c].y4 > a) { b = R[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2), { x1: a, x2: a }) : -1 } function s(a) { for (var b = 0; b < R.length; b++)I[b].isDirty || (a && (I[b].textBlock.ctx = a), I[b].textBlock.render(!0)) } function v(a) {
                            ...
                            for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, C = 0, E = x.height - 2 * z, G = Math.min(x.width - 2 * B, 2.8 * x.height), L = !1, S = 0; S < y.length; S++)if (!L && ("undefined" !== typeof y[S].indexLabel && null !== y[S].indexLabel && 0 < y[S].indexLabel.toString().length) && (L = !0), !L && ("undefined" !== typeof y[S].label && null !== y[S].label && 0 < y[S].label.toString().length) && (L = !0), !L && "function" === typeof u.indexLabelFormatter ||
                                "function" === typeof y[S].indexLabelFormatter) L = !0; L = L || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length; "inside" !== u.indexLabelPlacement && L || (B = (x.width - 0.75 * G) / 2); var S = x.x1 + B, K = x.x2 - B, $ = x.y1 + z, O = x.y2 - z, P = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                                    var Q, F; a = 75 * G / 100; var V = 30 * (K - a) / 100; "funnel" === u.type ? (Q = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight, F = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" ===
                                        typeof Q && Q.match(/%$/) ? (Q = parseInt(Q), Q = Q * E / 100) : Q = parseInt(Q), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), Q > E ? Q = E : 0 >= Q && (Q = 0), F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === u.type && (F = Q = 0, u.reversed = u.reversed ? !1 : !0); var B = S + a / 2, T = S, W = S + a, U = u.reversed ? O : $, N = B - F / 2, X = B + F / 2, Ba = u.reversed ? $ + Q : O - Q, ta = u.reversed ? $ : O; a = []; var B = [], R = [], G = [], Y = $, ba, aa = (Ba - U) / (N - T), fa = -aa, S = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d(); if (-1 !== S) {
                                            if (u.reversed) for (G.push(Y), F = S.length -
                                                1; 0 < F; F--)Y += S[F], G.push(Y); else for (F = 0; F < S.length; F++)Y += S[F], G.push(Y); if (u.reversed) for (F = 0; F < S.length; F++)G[F] < Ba ? (a.push(N), B.push(X), ba = F) : (a.push((G[F] - U + aa * T) / aa), B.push((G[F] - U + fa * W) / fa)); else for (F = 0; F < S.length; F++)G[F] < Ba ? (a.push((G[F] - U + aa * T) / aa), B.push((G[F] - U + fa * W) / fa), ba = F) : (a.push(N), B.push(X)); for (F = 0; F < S.length - 1; F++)Y = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length], F ===
                                                    ba ? R.push({ x1: a[F], y1: G[F], x2: B[F], y2: G[F], x3: X, y3: Ba, x4: B[F + 1], y4: G[F + 1], x5: a[F + 1], y5: G[F + 1], x6: N, y6: Ba, id: F, height: G[F + 1] - G[F], color: Y }) : R.push({ x1: a[F], y1: G[F], x2: B[F], y2: G[F], x3: B[F + 1], y3: G[F + 1], x4: a[F + 1], y4: G[F + 1], id: F, height: G[F + 1] - G[F], color: Y }); var ca = 2, I = [], ha = !1, Z = [], ia = [], S = !1; a = a = 0; Da(Z); for (F = 0; F < y.length; F++)y[F].exploded && (S = !0, u.reversed ? Z.push(y.length - 1 - F) : Z.push(F)); P.clearRect(x.x1, x.y1, x.width, x.height); P.fillStyle = A.backgroundColor; P.fillRect(x.x1, x.y1, x.width, x.height); if (L &&
                                                        u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) { l(); for (F = 0; F < y.length; F++)I[F].isDirty || (a = I[F].textBlock.x + I[F].width, a = (K - a) / 2, 0 == F && (C = a), C > a && (C = a)); for (F = 0; F < R.length; F++)R[F].x1 += C, R[F].x2 += C, R[F].x3 += C, R[F].x4 += C, R[F].x5 && (R[F].x5 += C, R[F].x6 += C), I[F].textBlock.x += C } for (F = 0; F < R.length; F++)C = R[F], sa(P, C, u.fillOpacity), ia.push(C.y1); v(P); L && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || n(P), A.animationEnabled || s()); if (!L) for (F = 0; F < y.length; F++)C = u.dataPointIds[F],
                                                            a = { id: C, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: R[u.reversed ? y.length - 1 - F : F] }, A._eventManager.objectMap[C] = a; !A.animationEnabled && S ? m(A, -1, 0) : A.animationEnabled && !A.animatedRender && m(A, -1, 0); this.funnelPyramidClickHandler = function (a) {
                                                                var b = -1; if (!ha && !A.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                                                    a = b; if ("funnel" === u.type || "pyramid" === u.type) u.reversed ? y[y.length - 1 - a].exploded =
                                                                        y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0; m(A, b, 500)
                                                                }
                                                            }; return { source: P, dest: this.plotArea.ctx, animationCallback: function (a, b) { M.fadeInAnimation(a, b); 1 <= a && (m(A, -1, 500), v(A.plotArea.ctx || A.ctx)) }, easingFunction: M.easing.easeInQuad, animationBase: 0 }
                                        }
                                }
                        }
                        ...
                        a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png", c = a.fileName ? a.fileName :
                            this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + d); var b = this.canvas; if (b && d && c) {
                                c = c + "." + d; a = "image/" + d; var b = b.toDataURL(a), e = !1, f = document.createElement("a"); f.download = c; f.href = b; if ("undefined" !== typeof Blob && new Blob) {
                                    for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), r = 0; r < l.length; r++)h[r] = l.charCodeAt(r); d = new Blob([h.buffer], { type: "image/" + d }); try { window.navigator.msSaveBlob(d, c), e = !0 } catch (k) {
                        ...
                        var f = this; e = "undefined" === typeof e ? 0 : e; if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                            var l = "#percent", h = "#total", r = this.getPercentAndTotal(c, d), h = isNaN(r.total) ? h : r.total, l = isNaN(r.percent) ? l : r.percent; do {
                                r = ""; if (c.percentFormatString) r = c.percentFormatString;
                                else { var r = "#,##0.", k = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2); if (isNaN(k) || !isFinite(k)) k = 2; for (var n = 0; n < k; n++)r += "#"; c.percentFormatString = r } a = a.replace("#percent", ca(l, r, f._cultureInfo)); a = a.replace("#total", ca(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
                    ...
                    }; pa(K, G); K.prototype.setLayout = function () {
                        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, l = 0, h = this.markerMargin = this.chart.options.legend &&
                            !r(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize; this.height = 0; var m = [], k = []; if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height; else if ("center" === this.verticalAlign) {
                                ...
                                var p = this.dataSeries[n]; if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                                    ...
                                    var x = p.dataPoints[y], q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : Q.getDefaultLegendMarker(p.type), g = x.legendText ? x.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: x }) : x.name ? x.name : "DataPoint: " +
                                        (y + 1), s = x.legendMarkerColor ? x.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : x.color ? x.color : p.color ? p.color : p._colorSet[y % p._colorSet.length], w = 0.75 * this.lineHeight, v = x.legendMarkerBorderColor ? x.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : x.markerBorderColor ? x.markerBorderColor : p.markerBorderColor, u = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : x.markerBorderThickness || p.markerBorderThickness ?
                                            Math.max(1, Math.round(0.2 * w)) : 0, g = this.chart.replaceKeywordsWithValue(g, x, p, y), q = { markerType: q, markerColor: s, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: n, dataPointIndex: y, markerBorderColor: v, markerBorderThickness: u }; (x.showInLegend || p.showInLegend && !1 !== x.showInLegend) && m.push(q)
                                }
                            } !0 === this.reversed && m.reverse(); if (0 < m.length) {
                                p = null; s = g = x = y = 0; x = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth,
                                    f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth = f; w = 0 === w ? 0.75 * this.lineHeight : w; x -= w + h; for (n = 0; n < m.length; n++) {
                        ...
                        var a = this.bounds.x1, d = this.bounds.y1, c = this.markerMargin, b = this.maxWidth, e = this.maxHeight, f = this.markerSize, l = this.rows; (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(a, d, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); for (var h = 0, r = 0; r < l.length; r++) {
                            for (var k = l[r], n = 0, p = 0; p <
                                k.items.length; p++) {
                                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing), s = d + h, m = g; this.chart.data[q.dataSeriesIndex].visible || (this.ctx.globalAlpha = 0.5); this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(a, d, b, Math.max(e - e % this.lineHeight, 0)); this.ctx.clip(); if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, s + this.lineHeight /
                                        2), this.ctx.lineTo(g + 0.85 * this.lineHeight, s + this.lineHeight / 2), this.ctx.stroke(), m -= 0.1 * this.lineHeight; if ("error" === q.chartType) {
                                            this.ctx.strokeStyle = this.errorMarkerColor[0]; this.ctx.lineWidth = f / 8; this.ctx.beginPath(); var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = s + 0.15 * this.lineHeight, y = 0.7 * this.lineHeight, x = y + 0.02 * this.lineHeight; this.ctx.moveTo(w, u); this.ctx.lineTo(w + y, u); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(w + y / 2, u); this.ctx.lineTo(w + y / 2, u + x); this.ctx.stroke(); this.ctx.beginPath();
                                            this.ctx.moveTo(w, u + x); this.ctx.lineTo(w + y, u + x); this.ctx.stroke(); this.errorMarkerColor.shift()
                    ...
                    }; pa(Q, G); Q.prototype.getDefaultAxisPlacement = function () {
                                            ...
                                            switch (this.type) {
                                                case "column": case "stackedColumn": case "stackedColumn100": case "bar": case "stackedBar": case "stackedBar100": case "rangeColumn": case "rangeBar": case "waterfall": case "error": a >=
                                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), h = !0); break; case "line": case "stepLine": case "spline": case "area": case "stepArea": case "stackedArea": case "stackedArea100": case "splineArea": case "scatter": var w = na("markerSize", g, this) || 4, v = c ? 20 : w, m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); m <= v && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m }); q =
                                                        Math.abs(q.x1 - a); q <= r ? r = q : 0 < l ? k++ : n++; m <= w / 2 && (h = !0); break; case "rangeArea": case "rangeSplineArea": w = na("markerSize", g, this) || 4; v = c ? 20 : w; m = Math.min(Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)), Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y2 - d, 2))); m <= v && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m }); q = Math.abs(q.x1 - a); q <= r ? r = q : 0 < l ? k++ : n++; m <= w / 2 && (h = !0); break; case "bubble": w = q.size; m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); m <= w / 2 && (b.push({
                                                            dataPoint: g, dataPointIndex: f, dataSeries: this,
                                                            distance: m
                                                        }), h = !0); break; case "pie": case "doughnut": w = q.center; v = "doughnut" === this.type ? q.percentInnerRadius * q.radius : 0; m = Math.sqrt(Math.pow(w.x - a, 2) + Math.pow(w.y - d, 2)); m < q.radius && m > v && (m = Math.atan2(d - w.y, a - w.x), 0 > m && (m += 2 * Math.PI), m = Number(((180 * (m / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), v = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === v && 1 < q.endAngle && (v = 360), w >= v && 0 !== g.y && (v += 360, m < w && (m += 360)), m > w && m < v && (b.push({
                                                            dataPoint: g,
                                                            dataPointIndex: f, dataSeries: this, distance: 0
                                                        }), h = !0)); break; case "funnel": case "pyramid": m = q.funnelSection; d > m.y1 && d < m.y4 && (m.y6 ? d > m.y6 ? (f = m.x6 + (m.x5 - m.x6) / (m.y5 - m.y6) * (d - m.y6), m = m.x3 + (m.x4 - m.x3) / (m.y4 - m.y3) * (d - m.y3)) : (f = m.x1 + (m.x6 - m.x1) / (m.y6 - m.y1) * (d - m.y1), m = m.x2 + (m.x3 - m.x2) / (m.y3 - m.y2) * (d - m.y2)) : (f = m.x1 + (m.x4 - m.x1) / (m.y4 - m.y1) * (d - m.y1), m = m.x2 + (m.x3 - m.x2) / (m.y3 - m.y2) * (d - m.y2)), a > f && a < m && (b.push({ dataPoint: g, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), h = !0)); break; case "boxAndWhisker": if (a >=
                        ...
                        }; pa(A, G); A.prototype.createExtraLabelsForLog = function (a) {
                            a = (a || 0) + 1; if (!(5 < a)) {
                                                                            ...
                                                                            a[g].valueType ? 2 : 1)].position, l = a[g].getApparentDifference(a[g].viewportMinimum, l), B = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (C = (d[g].logarithmic ?
                                                                                Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), B = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 :
                                                                                    (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1); for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < w) {
                                                                                        if (a && 0 < a.length) for (g = 0; g < a.length; g++)s = M[w - 1][g] === M[w][g] ? !0 : !1; else s = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)G = Q[w - 1][g] === Q[w][g] ? !0 : !1; else G = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)J = O[w - 1][g] === O[w][g] ? !0 : !1; else J = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)K = P[w -
                                            ...
                                            n.sessionVariables.axisY.height = p[g] : n.sessionVariables.axisY.height; else for (g = 0; g < c.length; g++)n.sessionVariables.axisY.height = p[g]; if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--)h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + Y), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + Y), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" ===
                                                c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = { x1: l, y1: h - (p[g] + Y + c[g].margin), x2: m, y2: k - (Y + c[g].margin), width: m - l, height: p[g] }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), Y += p[g] + c[g].margin; if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--)b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (C[g] + b[g].margin + F)), b[g].lineCoordinates.y1 =
                                                    k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = { x1: l, y1: h + (b[g].margin + F), x2: m, y2: k, width: m - l, height: V }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), F += C[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                                                        ...
                                                        N = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0; l = Math.round(f.x1 - e); h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 <
                                                        ...
                                                        if (a && 0 < a.length) for (g = 0; g < a.length; g++)s = M[w - 1][g] === M[w][g] ? !0 : !1; else s = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)G = Q[w - 1][g] === Q[w][g] ? !0 :
                                                            !1; else G = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)J = B[w - 1][g] === B[w][g] ? !0 : !1; else J = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)K = u[w - 1][g] === u[w][g] ? !0 : !1; else K = !0
                                                    } if (s && G && J && K) break; w++
                                ...
                                function () {
                                    ...
                                    if (this.scaleBreaks &&
                                        0 < this.scaleBreaks._appliedBreaks.length) {
                                            var a = this.scaleBreaks._appliedBreaks; w ? (this.maskCanvas = ua(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx); this.maskCtx.save(); this.maskCtx.beginPath(); this.maskCtx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.maskCtx.clip(); for (var d = 0; d < a.length; d++)a[d].endValue < this.viewportMinimum ||
                ...
                A.prototype.getLabelStartPoint = function () {
                ...
                }; pa(O, G); O.prototype.createUserOptions = function (a) {
                    ...
                    this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value), d = Math.abs("pixel" === this._thicknessType ? this.thickness : Math.abs(this.parent.convertValueToPixel(this.endValue) - this.parent.convertValueToPixel(this.startValue))); if (0 < d) {
                        var c = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var b = this.ctx.globalAlpha; this.ctx.globalAlpha = c; V(this.id); var e, f, h,
                ...
                }; pa(ba, G); ba.prototype.showAt = function (a) {
                            ...
                            { x: 0, y: 0, padding: { top: 2, right: 3, bottom: 2, left: 4 }, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness, cornerRadius: this.labelCornerRadius, maxWidth: this.labelMaxWidth, maxHeight: this.labelMaxHeight, angle: this.labelAngle, text: n, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle" }); if (this.snapToDataPoint) {
                                var s =
                                    0, n = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                                        var v = null; if ("bottom" === this.parent._position || "top" === this.parent._position) s = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d }); else if ("left" === this.parent._position || "right" === this.parent._position) s = this.parent.convertPixelToValue({ y: d }); for (var B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible &&
                                            n.push(v)); v = null; if (0 === n.length) return; n.sort(function (a, b) { return a.distance - b.distance }); v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); B = 0; if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[B].dataPoint.y[0])), u = 0, s = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (var y = 0; y < n[s].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else u =
                                                Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, B = s); else if ("stackedBar" === n[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), x = u = 0, s = B = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y = 0; y < n[s].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else x += n[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, B = s); else if ("stackedBar100" === n[0].dataSeries.type) for (var v =
                                                    Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = x = u = 0, s = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y = 0; y < n[s].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else x += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (x / n[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = s); else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                                        s = B = u = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y = 0; y < n[s].dataPoint.y.length; y++)u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else u = Math.abs(a - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, B = s); y = n[B]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                                                            b = 0; if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                                                                ...
                                                                v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); x = u = 0; for (s = B; 0 <= s; s--)x += n[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, b = s); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0; this.value = x; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y }) : r(this.options.label) ?
                                                                ...
                                                                v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = x = u = 0; for (s = B; 0 <= s; s--)x += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (x / n[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = s); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 :
                                                                    this.parent.convertValueToPixel(z) << 0; this.value = z; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z }) : r(this.options.label) ? ca(r(c) ? z : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                                                            ...
                                                            f = h = w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.x) << 0; b = this.chart.plotArea.x1; e = this.chart.plotArea.x2; this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 }; z = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s +=
                                                                ...
                                                                }) : r(this.options.label) ? Aa(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : r(this.options.label) ? ca(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); this.value = y.dataPoint.x; k.y = h + k.fontSize / 2 - k.measureText().height /
                                        ...
                                        s = this.parent.convertPixelToValue({ x: a }); for (B = 0; B < this.parent.dataSeries.length; B++)(v =
                                            ...
                                            "boxAndWhisker" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), s = u = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y = 0; y < n[s].dataPoint.y.length; y++)u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, B = s); else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                                s = x = u = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y = 0; y < n[s].dataPoint.y.length; y++)u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else x += n[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, B = s); else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = z = x = u = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y =
                                                    0; y < n[s].dataPoint.y.length; y++)u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else x += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (x / n[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, B = s); else for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), s = u = 0; s < n.length; s++)if (n[s].dataPoint.y && n[s].dataPoint.y.length) for (y = 0; y < n[s].dataPoint.y.length; y++)u =
                                                        Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y[y])), u < v && (v = u, B = s); else u = Math.abs(d - this.parent.convertValueToPixel(n[s].dataPoint.y)), u < v && (v = u, B = s); y = n[B]; b = 0; if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                                                            v =
                                                            ...
                                                            v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); x = u = 0; for (s = B; 0 <= s; s--)x += n[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, b = s); w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x) << 0) + 0.5 : this.parent.convertValueToPixel(x) << 0; k.text = this.labelFormatter ? this.labelFormatter({
                                                                chart: this.chart,
                                                                axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y
                                                            }) : r(this.options.label) ? ca(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = x
                                                        } else if ("stackedColumn100" === this.parent.dataSeries[B].type || "stackedArea100" === this.parent.dataSeries[B].type) {
                                                            v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); x = u = 0; for (s = B; 0 <= s; s--)x += n[s].dataPoint.y, z = n[s].dataPoint.x.getTime ? n[s].dataPoint.x.getTime() : n[s].dataPoint.x, z = 100 * (x / n[s].dataSeries.plotUnit.dataPointYSums[z]),
                                ...
                                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h }; else if ("left" === this.parent._position || "right" === this.parent._position) f = h = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" ===
                                    this.parent._position || "right" === this.parent._position) {
                                        z = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n)if (this.parent.labels[s]) z = !0; else { z = !1; break } if (z) {
                                            if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ y: d }), v = null, B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                        ...
                                        }) : r(this.options.label) ? ca(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label); k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2; k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2); "left" === this.parent._position ?
                                    ...
                                    z = !1; n = ""; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += n)if (this.parent.labels[s]) z =
                                        !0; else { z = !1; break } if (z) { if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ x: a }), v = null, B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? r(c) ? v.dataPoint.label : c : this.label) } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ?
                                            this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? Aa(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c }) : r(this.options.label) ?
                                                ca(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label); k.x = b - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width); k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1); "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2)
                ...
                }; ba.prototype.renderLabel = function () { r(this._textBlock) || (r(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden) || this._textBlock.render(!0) }; pa(U, G); U.prototype._initialize = function () {
                    ...
                    function () { return ++this.lastObjectId }; Z.prototype.mouseEventHandler = function (a) {
                        ...
                        var f = this; this.chart.isAnimating = !0; e = e || M.easing.linear; c && this.animations.push({ startTime: (new Date).getTime() + (a ? a : 0), duration: d, animationCallback: c, onComplete: b }); for (a = []; 0 < this.animations.length;)if (d = this.animations.shift(), c = (new Date).getTime(), b = 0, d.startTime <= c && (b = e(Math.min(c - d.startTime, d.duration), 0, 1, d.duration), b = Math.min(b, 1), isNaN(b) || !isFinite(b)) && (b = 1),
                    ...
                    }; ia.prototype.cancelAllAnimations = function () { this.animations = []; this.animationRequestId && this.chart.cancelRequestAnimFrame.call(window, this.animationRequestId); this.animationRequestId = null; this.chart.isAnimating = !1 }; var M = {
